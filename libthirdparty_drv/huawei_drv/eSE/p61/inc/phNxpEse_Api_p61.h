...
#ifndef _PHNXPSPILIB_API_P61_H_
#define _PHNXPSPILIB_API_P61_H_
#include <stdlib.h>
#include <securec.h>
 ...
 *
 */
typedef struct phNxpEse_data_p61 {
 ...
 */
typedef enum {
  P61_ESE_MODE_NORMAL = 0, /*!< All wired transaction other OSU */
  P61_ESE_MODE_OSU         /*!< Jcop Os update mode */
} phNxpEse_initMode_p61;

/**
 * \ingroup spi_libese
 * \brief Ese library init parameters to be set while calling phNxpEse_init_p61
 *
 */
typedef struct phNxpEse_initParams_p61 {
  phNxpEse_initMode_p61 initMode; /*!< Ese communication mode */
} phNxpEse_initParams_p61;

/*!
 * \brief SEAccess kit MW Android version
 */
#define P61_NXP_ANDROID_VER (8U)

/*!
 * \brief SEAccess kit MW Major version
 */
#define P61_ESELIB_MW_VERSION_MAJ (0x3)

/*!
 * \brief SEAccess kit MW Minor version
 */
#define P61_ESELIB_MW_VERSION_MIN (0x00)
 ...
 *
 * \param[in]       phNxpEse_data_p61: Command to ESE
 * \param[out]     phNxpEse_data_p61: Response from ESE (Returned data to be freed
 *after copying)
 *
 * \retval ESESTATUS_SUCCESS On Success ESESTATUS_SUCCESS else proper error code
 *
 ...
 * \ingroup spi_libese
 *
 * \brief  This function is called by Jni/phNxpEse_close_p61 during the
 ...
 *
 * \param[in]       phNxpEse_data_p61 timer_buffer
 *
 * \retval ESESTATUS_SUCCESS Always return ESESTATUS_SUCCESS (0).
 *
 */
