 ...
 * Create: 2019-03
 */
#ifndef SECURE_SERIAL_PLAT_H
#define SECURE_SERIAL_PLAT_H

#include "soc_acpu_baseaddr_interface.h"
/* Serial Configuration */
#ifdef REG_BASE_UART0
#undef REG_BASE_UART0
#endif
#define REG_BASE_UART0 SOC_ACPU_UART0_BASE_ADDR

#ifdef REG_BASE_UART2
#undef REG_BASE_UART2
#endif
#define REG_BASE_UART2                  (0xFDF03000)

#ifdef REG_BASE_UART6
#undef REG_BASE_UART6
#endif

#define REG_BASE_UART6 SOC_ACPU_UART6_BASE_ADDR

#define REG_BASE_CONSOLE	REG_BASE_UART0

#define CFG_SERIAL		REG_BASE_UART0
#define MHZ                       (1000*1000)
#define CFG_CLK_CPU_BASE          40          /* cpu freq 90MHZ in FPGA platform */
#define CFG_CLK_OTHER_BASE        26
#define CFG_CLK_CPU               (CFG_CLK_CPU_BASE*MHZ)
#define CFG_CLK_OTHER             (CFG_CLK_OTHER_BASE*MHZ)
#define CONFIG_PL011_CLOCK	(19200000)

#define CONFIG_PL01x_PORTS	{(void *)CFG_SERIAL}
#define CONFIG_CONS_INDEX	0       /* select the default console */
#define CONFIG_BAUDRATE		115200

/* IOMG for UART0 For k3v3 FPGA B040 */
#define     IOMG_059    (REG_BASE_IOC + 0x0F0)
#define     IOMG_060    (REG_BASE_IOC + 0x0F4)

#define     IOMG_061    (REG_BASE_IOC + 0x0F8)
#define     IOMG_062    (REG_BASE_IOC + 0x0FC)
#define     IOMG_063    (REG_BASE_IOC + 0x100)
#define     IOMG_064    (REG_BASE_IOC + 0x108)

/* IOCG for UART0 */
#define     IOCG_136    (REG_BASE_IOC + 0xA00)
#define     IOCG_137    (REG_BASE_IOC + 0xA04)
#define     IOCG_138    (REG_BASE_IOC + 0xA08)
#define     IOCG_139    (REG_BASE_IOC + 0xA0C)

#define     IOCG_140    (REG_BASE_IOC + 0xA10)
#define     IOCG_141    (REG_BASE_IOC + 0xA14)
#define     IOCG_142    (REG_BASE_IOC + 0xA18)
#define     IOCG_143    (REG_BASE_IOC + 0xA1C)
#define     IOCG_144    (REG_BASE_IOC + 0xA20)
#define     IOCG_145    (REG_BASE_IOC + 0xA24)
#define     IOCG_146    (REG_BASE_IOC + 0xA28)
#define     IOCG_147    (REG_BASE_IOC + 0xA2C)

#define IOC_UART0_IOMG              IOMG_059
#define IOC_UART0_IOMG_RXD_TXD_BIT  (0x1 << 1)
...
/* store uart config info */
#define SCBAKDATA6_OFFSET (0x32c)
#endif /*__SECURE_SERIAL_PLAT__H */
