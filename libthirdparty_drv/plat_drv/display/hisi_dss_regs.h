...
#define CMDLIST_CH1_PENDING_CLR	(0x0040)
#define CMDLIST_CH1_CTRL	(0x0044)
#define CMDLIST_CH1_STATUS	(0x0048)
#define CMDLIST_CH1_STAAD	(0x004C)
#define CMDLIST_CH1_CURAD	(0x0050)
#define CMDLIST_CH1_INTE	(0x0054)
#define CMDLIST_CH1_INTC	(0x0058)
#define CMDLIST_CH1_INTS	(0x005C)

#define CMDLIST_CH2_PENDING_CLR	(0x0080)
#define CMDLIST_CH2_CTRL	(0x0084)
#define CMDLIST_CH2_STATUS	(0x0088)
#define CMDLIST_CH2_STAAD	(0x008C)
#define CMDLIST_CH2_CURAD	(0x0090)
#define CMDLIST_CH2_INTE	(0x0094)
#define CMDLIST_CH2_INTC	(0x0098)
#define CMDLIST_CH2_INTS	(0x009C)

#define CMDLIST_CH3_PENDING_CLR	(0x00C0)
#define CMDLIST_CH3_CTRL	(0x00C4)
#define CMDLIST_CH3_STATUS	(0x00C8)
#define CMDLIST_CH3_STAAD	(0x00CC)
#define CMDLIST_CH3_CURAD	(0x00D0)
#define CMDLIST_CH3_INTE	(0x00D4)
#define CMDLIST_CH3_INTC	(0x00D8)
#define CMDLIST_CH3_INTS	(0x00DC)

#define CMDLIST_CH4_PENDING_CLR	(0x0100)
#define CMDLIST_CH4_CTRL	(0x0104)
#define CMDLIST_CH4_STATUS	(0x0108)
#define CMDLIST_CH4_STAAD	(0x010C)
#define CMDLIST_CH4_CURAD	(0x0110)
#define CMDLIST_CH4_INTE	(0x0114)
#define CMDLIST_CH4_INTC	(0x0118)
#define CMDLIST_CH4_INTS	(0x011C)

#define CMDLIST_CH5_PENDING_CLR	(0x0140)
#define CMDLIST_CH5_CTRL	(0x0144)
#define CMDLIST_CH5_STATUS	(0x0148)
#define CMDLIST_CH5_STAAD	(0x014C)
#define CMDLIST_CH5_CURAD	(0x0150)
#define CMDLIST_CH5_INTE	(0x0154)
#define CMDLIST_CH5_INTC	(0x0158)
#define CMDLIST_CH5_INTS	(0x015C)
...
//0x0160+16*k
#define MIF_STAT0_BASE	(0x0160)
//0x0164+16*k
#define MIF_STAT1_BASE	(0x0164)
//0x0168+16*k
#define MIF_STAT2_BASE	(0x0168)
...
typedef struct dss_mctl_ch_base {
	uint32_t chn_mutex_base;
	uint32_t chn_flush_en_base;
	uint32_t chn_ov_en_base;
	uint32_t chn_starty_base;
	uint32_t chn_mod_dbg_base;
} dss_mctl_ch_base_t;
