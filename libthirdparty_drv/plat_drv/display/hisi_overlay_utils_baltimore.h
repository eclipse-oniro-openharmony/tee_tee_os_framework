#ifndef HISI_OVERLAY_UTILS_BALTIMORE_H
#define HISI_OVERLAY_UTILS_BALTIMORE_H
#include "hisi_dss.h"

#define DSS_POWER_ON_STAT       (0x000cc000)

#define HISI_FB_SEC_IRQ         (399) // intr_mcu_dsi0: 367 + 32
#define HISI_DSS_SEC_RCH_INDEX  (DSS_RCHN_V0)
#define DSS_SEC_RCH_DMA_OFFSET  (DSS_RCH_VG0_DMA_OFFSET)
...
#endif  /* HISI_OVERLAY_UTILS_KIRIN990_H */
