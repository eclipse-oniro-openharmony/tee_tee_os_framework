...
ifneq ($(filter $(TARGET_BOARD_PLATFORM), baltimore), )
    CFILES += platform/libthirdparty_drv/plat_drv/display2.0/channel_data/hisi_dss_channel_data_kirin9a0_base.c \
...
ifneq ($(filter $(TARGET_BOARD_PLATFORM), kirin990), )
    CFILES += platform/libthirdparty_drv/plat_drv/display2.0/channel_data/hisi_dss_channel_data_kirin980_base.c \
    ...
    inc-flags += -DCONFIG_DSS_TYPE_KIRIN990
endif
