...
#ifndef __KIRIN_HISI_RELOAD_HIFI_H__
#define __KIRIN_HISI_RELOAD_HIFI_H__
...
#else /* WITH_CHIP_HI6250 */
#define HIFI_IMAGE_TCMBAK_SIZE          0x34000UL

#if (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_HI3670)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x8D500000UL
#define HISI_RESERVED_HIFI_PHYMEM_BASE_FAMA 0x5AD500000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x8E300000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_HI6260)
#ifdef CONFIG_AP_CUST_2G_MEM
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x13000000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x10200000UL
#else
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x14400000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x2D500000UL
#endif
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_HI3680 || TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_KIRIN990)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x2DA00000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x2E980000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_DENVER)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x34C00000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x19100000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_ORLANDO)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x17800000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x2D500000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_BALTIMORE)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x2DA00000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x2F380000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_MIAMICW)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x15B00000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x13980000UL
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_LAGUNA)
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x19E00000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x1AE90000UL
#else
#define HISI_RESERVED_HIFI_PHYMEM_BASE      0x89200000UL
#define HISI_RESERVED_HIFI_PHYMEM_BASE_FAMA 0x5A9200000UL
#define HISI_RESERVED_HIFI_DATA_PHYMEM_BASE 0x8B600000UL
#endif
...
#endif /* __KIRIN_HISI_RELOAD_HIFI_H__ */
