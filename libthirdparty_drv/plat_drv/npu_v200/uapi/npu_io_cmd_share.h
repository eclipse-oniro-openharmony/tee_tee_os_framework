...
#ifndef __NPU_IO_CMD_SHARE_H__
#define __NPU_IO_CMD_SHARE_H__
...
#define DEVDRV_GET_DEV_INFO _IO(DEVDRV_ID_MAGIC, 15)
#define DEVDRV_GET_SCH_RESULT _IO(DEVDRV_ID_MAGIC, 16)
