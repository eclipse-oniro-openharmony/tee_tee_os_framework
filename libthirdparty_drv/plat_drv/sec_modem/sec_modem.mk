...
inc-flags += -I$(SECURE_OS_DIR)/drivers/platdrv/platform/common/crypto
...
inc-flags += -I$(SECURE_OS_DIR)/libs/libplatdrv/platform/libthirdparty_drv/plat_drv/secureboot
inc-flags += -I$(SECURE_OS_DIR)/libs/libplatdrv/platform/libthirdparty_drv/plat_drv/secureboot/bspatch
...
ifeq ($(chip_type),cs2)
inc-flags      += -I$(SECURE_OS_DIR)/../../../../../vendor/hisi/ap/platform/$(TARGET_BOARD_PLATFORM)_cs2
else
ifeq ($(chip_type),es)
...
include $(SECURE_OS_DIR)/libs/libplatdrv/platform/libthirdparty_drv/plat_drv/sec_modem/teeos/modem_build.mk
