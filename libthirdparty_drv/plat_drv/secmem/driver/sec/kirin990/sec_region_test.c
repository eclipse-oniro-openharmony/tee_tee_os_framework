...
static int sub_rgn_cfg_test(u32 feature_num, u32 segment_num)
{
	...
	reg3_val = readl(SOC_DMSS_ASI_SEC_SUB_RGN3_ADDR(REG_BASE_DMSS, SUB_RGN_NUM(g_sub_rgn_cfg_table[feature_num].region_num), CPU_ASI_NUM));
	reg2_val = readl(SOC_DMSS_ASI_SEC_SUB_RGN2_ADDR(REG_BASE_DMSS, SUB_RGN_NUM(g_sub_rgn_cfg_table[feature_num].region_num), CPU_ASI_NUM));
...
static int normal_rgn_test_base(u32 feature_num, u32 segment_num, u32 start_addr, u32 npages)
{
	...
	reg_map0_val = readl(SOC_DMSS_ASI_SEC_RGN_MAP0_ADDR(REG_BASE_DMSS, g_normal_rgn_cfg_table[feature_num].region_num, CPU_ASI_NUM));
	reg_map1_val = readl(SOC_DMSS_ASI_SEC_RGN_MAP1_ADDR(REG_BASE_DMSS, g_normal_rgn_cfg_table[feature_num].region_num, CPU_ASI_NUM));
