...
PNG_EXPORT(378, void, png_read_png_ext, (png_structrp png_ptr, png_inforp info_ptr,
    int transforms, png_voidp params, char *xbuf, int pitch));
#endif
#ifdef PNG_WRITE_SUPPORTED
...
void png_set_r(png_structp png_ptr, int r);
#ifdef __cplusplus
}
#endif
