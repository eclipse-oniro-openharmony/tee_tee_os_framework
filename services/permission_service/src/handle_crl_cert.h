 ...
 * Description: handle crl cert
 * Author: TianJianliang tianjianliang@huawei.com
 * Create: 2016-04-01
 */
#ifndef PERMISSION_SERVICE_HANDLE_CRL_CERT_H
#define PERMISSION_SERVICE_HANDLE_CRL_CERT_H
...
struct crl_issuer_t {
    ...
    struct dlist_node revoked_entry_list;
};
