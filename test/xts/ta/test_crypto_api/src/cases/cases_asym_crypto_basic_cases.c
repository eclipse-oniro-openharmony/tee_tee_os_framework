...
int CaseAsymEncryptRsaV15KeySize512Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaV15KeySize512Multi success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaV15KeySize1280Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaV15KeySize1280Once success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaV15KeySize1280Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaV15KeySize1280Multi success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaOaepSha256KeySize1280Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaOaepSha256KeySize1280Once success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaOaepSha256KeySize1280Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaOaepSha256KeySize1280Multi success\n", __func__);
    return 0;
}
...
// iTrustee_Crypto_AsymEncrypt_Fun_005
int CaseAsymEncryptRsaNopadKeySize512Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaNopadKeySize512Once success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaNopadKeySize512Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaNopadKeySize512Multi success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaNopadKeySize1280Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaNopadKeySize1280Once success\n", __func__);
    return 0;
}
...
int CaseAsymEncryptRsaNopadKeySize1280Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymEncryptRsaNopadKeySize1280Multi success\n", __func__);
    return 0;
}
