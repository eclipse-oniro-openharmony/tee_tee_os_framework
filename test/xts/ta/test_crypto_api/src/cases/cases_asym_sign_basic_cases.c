...
int CaseAsymSignRsaV15Sha224KeySize512Once(void)
{
    ...
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha224KeySize512Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaV15Sha224KeySize512Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha224KeySize512Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaV15Sha256KeySize768Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha256KeySize768Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaV15Sha256KeySize768Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha256KeySize768Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaV15Sha256KeySize1024Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha256KeySize1024Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaV15Sha256KeySize1024Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaV15Sha256KeySize1024Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha1KeySize512Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha1KeySize512Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha1KeySize512Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha1KeySize512Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha224KeySize768Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha224KeySize768Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha224KeySize768Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha224KeySize768Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha256KeySize1024Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha256KeySize1024Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignRsaPssSha256KeySize1024Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignRsaPssSha256KeySize1024Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignSm2DsaSm3DataSize128Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignSm2DsaSm3DataSize128Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignSm2DsaSm3DataSize512Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignSm2DsaSm3DataSize512Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignSm2DsaSm3DataSize512Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignSm2DsaSm3DataSize512Multi success\n", __func__);
    return 0;
}
...
int CaseAsymSignSm2DsaSm3DataSize1024Once(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignSm2DsaSm3DataSize1024Once success\n", __func__);
    return 0;
}
...
int CaseAsymSignSm2DsaSm3DataSize1024Multi(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseAsymSignSm2DsaSm3DataSize1024Multi success\n", __func__);
    return 0;
}
