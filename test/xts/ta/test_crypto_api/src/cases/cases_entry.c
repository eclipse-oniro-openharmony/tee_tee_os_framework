...
static CaseEntry g_caseEntryList[] = {
    ...
    {
        .name = "CaseSymEncryptAesCtsKeySize256OnceOnce",
        .entry = CaseSymEncryptAesCtsKeySize256OnceOnce,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseSymEncryptAesCtsKeySize256OnceMulti",
        .entry = CaseSymEncryptAesCtsKeySize256OnceMulti,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseSymEncryptAesCtsKeySize256MultiOnce",
        .entry = CaseSymEncryptAesCtsKeySize256MultiOnce,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseSymEncryptAesCtsKeySize256MultiMulti",
        .entry = CaseSymEncryptAesCtsKeySize256MultiMulti,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseHmacSipHashKeySize128OnceOnce",
        .entry = CaseHmacSipHashKeySize128OnceOnce,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseHmacSipHashKeySize128OnceMulti",
        .entry = CaseHmacSipHashKeySize128OnceMulti,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseHmacSipHashKeySize128MultiOnce",
        .entry = CaseHmacSipHashKeySize128MultiOnce,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseHmacSipHashKeySize128MultiMulti",
        .entry = CaseHmacSipHashKeySize128MultiMulti,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymEncryptRsaV15KeySize512Multi",
        .entry = CaseAsymEncryptRsaV15KeySize512Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaV15KeySize1280Once",
        .entry = CaseAsymEncryptRsaV15KeySize1280Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaV15KeySize1280Multi",
        .entry = CaseAsymEncryptRsaV15KeySize1280Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymEncryptRsaOaepSha256KeySize1280Once",
        .entry = CaseAsymEncryptRsaOaepSha256KeySize1280Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaOaepSha256KeySize1280Multi",
        .entry = CaseAsymEncryptRsaOaepSha256KeySize1280Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymEncryptRsaNopadKeySize512Once",
        .entry = CaseAsymEncryptRsaNopadKeySize512Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaNopadKeySize512Multi",
        .entry = CaseAsymEncryptRsaNopadKeySize512Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaNopadKeySize1280Once",
        .entry = CaseAsymEncryptRsaNopadKeySize1280Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymEncryptRsaNopadKeySize1280Multi",
        .entry = CaseAsymEncryptRsaNopadKeySize1280Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymSignRsaV15Sha224KeySize512Once",
        .entry = CaseAsymSignRsaV15Sha224KeySize512Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaV15Sha224KeySize512Multi",
        .entry = CaseAsymSignRsaV15Sha224KeySize512Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaV15Sha256KeySize768Once",
        .entry = CaseAsymSignRsaV15Sha256KeySize768Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaV15Sha256KeySize768Multi",
        .entry = CaseAsymSignRsaV15Sha256KeySize768Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaV15Sha256KeySize1024Once",
        .entry = CaseAsymSignRsaV15Sha256KeySize1024Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaV15Sha256KeySize1024Multi",
        .entry = CaseAsymSignRsaV15Sha256KeySize1024Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymSignRsaPssSha1KeySize512Once",
        .entry = CaseAsymSignRsaPssSha1KeySize512Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaPssSha1KeySize512Multi",
        .entry = CaseAsymSignRsaPssSha1KeySize512Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaPssSha224KeySize768Once",
        .entry = CaseAsymSignRsaPssSha224KeySize768Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaPssSha224KeySize768Multi",
        .entry = CaseAsymSignRsaPssSha224KeySize768Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaPssSha256KeySize1024Once",
        .entry = CaseAsymSignRsaPssSha256KeySize1024Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignRsaPssSha256KeySize1024Multi",
        .entry = CaseAsymSignRsaPssSha256KeySize1024Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
    ...
    {
        .name = "CaseAsymSignSm2DsaSm3DataSize128Multi",
        .entry = CaseAsymSignSm2DsaSm3DataSize128Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignSm2DsaSm3DataSize512Once",
        .entry = CaseAsymSignSm2DsaSm3DataSize512Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignSm2DsaSm3DataSize512Multi",
        .entry = CaseAsymSignSm2DsaSm3DataSize512Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignSm2DsaSm3DataSize1024Once",
        .entry = CaseAsymSignSm2DsaSm3DataSize1024Once,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
        .name = "CaseAsymSignSm2DsaSm3DataSize1024Multi",
        .entry = CaseAsymSignSm2DsaSm3DataSize1024Multi,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    ...
    {
        .name = "CaseDRDHKeySize2048Pram2048DataSize1024",
        .entry = CaseDRDHKeySize2048Pram2048DataSize1024,
        .ranFlag = CASE_RAN_FLAG_CLEAR,
        .ret = -1,
    },
    {
