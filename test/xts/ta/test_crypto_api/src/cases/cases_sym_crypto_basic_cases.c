...
int CaseSymEncryptAesCtsKeySize256OnceOnce(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseSymEncryptAesCtsKeySize256OnceOnce success\n", __func__);
    return 0;
}
...
int CaseSymEncryptAesCtsKeySize256OnceMulti(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseSymEncryptAesCtsKeySize256OnceMulti success\n", __func__);
    return 0;
}
...
int CaseSymEncryptAesCtsKeySize256MultiOnce(void)
{
    ...
    tlogi("----------------fwdengine: %u, bckengine: %u\n", tv.fwdEngine, tv.bckEngine);
    int ret = MonadRun2(&tv);
    if (ret != 0) {
        tloge("[%s]:MonadRun2 failed\n", __func__);
        return -1;
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseSymEncryptAesCtsKeySize256MultiOnce success\n", __func__);
    return 0;
}
...
int CaseSymEncryptAesCtsKeySize256MultiMulti(void)
{
    ...
    tlogi("[%s]:MonadRun2 success\n", __func__);
    tlogi("[%s]:--------------CaseSymEncryptAesCtsKeySize256MultiMulti success\n", __func__);
    return 0;
}
