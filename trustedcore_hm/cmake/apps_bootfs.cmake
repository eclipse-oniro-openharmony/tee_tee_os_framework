...
if ("${CONFIG_TEE_DRV_SERVER_64BIT}" STREQUAL "true" OR "${CONFIG_TEE_MISC_DRIVER_64BIT}" STREQUAL "true")
    list(APPEND BOOTFS_FILES ${BOOTFS_STAGE_DIR}/libdrv_shared.so)
endif()

if ("${CONFIG_TEE_DRV_SERVER_64BIT}" STREQUAL "false" OR "${CONFIG_TEE_MISC_DRIVER_64BIT}" STREQUAL "false")
