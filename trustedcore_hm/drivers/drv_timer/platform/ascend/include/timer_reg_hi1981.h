...
#define SPI_NUM_FOR_NOTIFY 476

/* 1981 secure timer */
#define FREE_RUNNING_FIQ_NUMBLER     72
#define TICK_TIMER_FIQ_NUMBLER       73

#define SC_SEC_TIMER_CLK_SEL    (SUBCTRL_REG + 0x200C)
#define SC_OS_TIMER0_RESET_DREQ (SUBCTRL_REG + 0xD6C)
#define SC_OS_TIMER1_RESET_DREQ (SUBCTRL_REG + 0xD6C)
