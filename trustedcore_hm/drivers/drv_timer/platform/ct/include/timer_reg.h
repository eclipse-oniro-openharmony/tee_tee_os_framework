 ...
 * Create: 2021-03-09
 */
#ifndef DRV_TIMER_PLATFORM_TIMER_CT_H
#define DRV_TIMER_PLATFORM_TIMER_CT_H
...
#define TIMER_CLK_FREQ 200000000 /* 200M */
...
#define SPI_NUM_FOR_NOTIFY 366

/* hi1620 secure timer for totem_b */
#define FREE_RUNNING_FIQ_NUMBLER     132
#define TICK_TIMER_FIQ_NUMBLER       133

#define SC_SECURE_TIMER_CLK_ST  (SUBCTRL_REG + 0x5560)
#define SC_SECURE_TIMER_CLK_EN  (SUBCTRL_REG + 0x560)
#define SC_SECURE_TIMER0_CLK_DIS (SUBCTRL_REG + 0x564)
#define SC_SECURE_TIMER_CLK_SEL (SUBCTRL_REG + 0x3118)
