...
#ifndef DRV_TIMER_PLATFORM_SYS_KIRIN_H
#define DRV_TIMER_PLATFORM_SYS_KIRIN_H

#ifdef REG_BASE_SCTRL
#undef REG_BASE_SCTRL
#endif
#if (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_KIRIN990)
#define REG_BASE_SCTRL          0xFA89B000U /* SCTRL kirin990 */
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_BALTIMORE)
#define REG_BASE_SCTRL          0xFA89B000U /* SCTRL baltimore */
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_DENVER)
#define REG_BASE_SCTRL          0xFA89B000U /* SCTRL baltimore */
#else
#define REG_BASE_SCTRL          0xFFF0A000U
#endif
...
#define SCPEREN0                (REG_BASE_SCTRL + 0x030)
#define SCPERCLKEN0             (REG_BASE_SCTRL + 0x038)
#define SCPEREN1                (REG_BASE_SCTRL + 0x040)
#define SCPERCLKEN1             (REG_BASE_SCTRL + 0x048)
#else
...
#endif
#if (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_KIRIN990)
#define REG_BASE_PERI_CRG       0xFFF05000U /* PERI_CRG kirin990 */
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_BALTIMORE)
#define REG_BASE_PERI_CRG       0xFFF05000U /* PERI_CRG baltimore */
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_DENVER)
#define REG_BASE_PERI_CRG       0xFFF05000U /* PERI_CRG baltimore */
#else
#define REG_BASE_PERI_CRG       0xFFF35000U
#endif
...
#define REG_BASE_PCTRL			(0xFE02E000U)
#else
#define REG_BASE_PCTRL                  (0xFFA2E000U)
#endif
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_BALTIMORE)
#define REG_BASE_PCTRL          0xFEC3E000U
#elif (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_DENVER)
#define REG_BASE_PCTRL          0xFEC3E000U
#else
#define REG_BASE_PCTRL          0xE8A09000U
#endif
...
#if (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_HI3650)
/* secure timer control reg in austin */
#define SCTIMERCTRL_SEC        (REG_BASE_SCTRL + 0x9A0)
#else
/* secure timer control reg in chicago/dallas/boston */
...
#define REG_BASE_IOC                0xE8612000U
#define REG_BASE_SPI0               0xFDF07000U
#define REG_BASE_SPI1               0xFDF08000U
#define REG_BASE_GPIO0              0xE8A0B000U
#define REG_BASE_GPIO1              0xE8A0C000U
#define REG_BASE_GPIO2              0xE8A0D000U
#define REG_BASE_GPIO3              0xE8A0E000U
#define REG_BASE_GPIO4              0xE8A0F000U
#define REG_BASE_GPIO5              0xE8A10000U
#define REG_BASE_GPIO6              0xE8A11000U
#define REG_BASE_GPIO7              0xE8A12000U
#define REG_BASE_GPIO8              0xE8A13000U
#define REG_BASE_GPIO9              0xE8A14000U
#define REG_BASE_GPIO10             0xE8A15000U
#define REG_BASE_GPIO11             0xE8A16000U
#define REG_BASE_GPIO12             0xE8A17000U
#define REG_BASE_GPIO13             0xE8A18000U
#define REG_BASE_GPIO14             0xE8A19000U
#define REG_BASE_GPIO15             0xE8A1A000U
#define REG_BASE_GPIO16             0xE8A1B000U
#define REG_BASE_GPIO17             0xE8A1C000U
#define REG_BASE_GPIO18             0xE8A1D000U
#define REG_BASE_GPIO19             0xE8A1E000U
#define REG_BASE_GPIO20             0xE8A1F000U
#define REG_BASE_GPIO21             0xE8A20000U
#define REG_BASE_GPIO22             0xFFF0B000U
#define REG_BASE_GPIO23             0xFFF0C000U
#define REG_BASE_GPIO24             0xFFF0D000U
#define REG_BASE_GPIO25             0xFFF0E000U
#define REG_BASE_GPIO26             0xFFF0F000U
...
#define SOC_SC_ON_BASE_ADDR                           0xF7410000U
...
#define PERIPHERAL_BASE_CTRL    0xE8A09000U
#define PCPEREN1                (PERIPHERAL_BASE_CTRL + 0x10)
#define PCPERCLKEN1             (PERIPHERAL_BASE_CTRL + 0x18)

#define EFUSEC_PHY_BASE         0xFFF10000U
#define PMURTC_PHY_BASE         0xFFF34000U

#ifdef REG_BASE_DMA0
#undef REG_BASE_DMA0
#endif
#define REG_BASE_DMA0           0xFDF30000U
...
#endif /* DRV_TIMER_PLATFORM_SYS_KIRIN_H */
