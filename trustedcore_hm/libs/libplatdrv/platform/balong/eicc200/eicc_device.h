...
struct eicc_channel {
    ...
    osl_spinlock_t lock; /* 保护通道互斥的spin锁 */
...
struct eicc_dev_bk {
    ...
    u32 glb_secctrl;
    u32 core_secctrl;
    u32 opipe_sec[EICC_PIPE_SEC_REGS_CNT];
    u32 ipipe_sec[EICC_PIPE_SEC_REGS_CNT];
#endif
#if EICC_FEATURE_INNERCHN_SUPPORT
    u32 ipipe_int_msk[EICC_CHN_ID_MAX];
#endif
};
