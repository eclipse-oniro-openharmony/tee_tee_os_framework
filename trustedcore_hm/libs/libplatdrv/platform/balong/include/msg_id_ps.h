...
#define MDRV_MSG_PS_MIDS \
        ...
        /* 卡1的PID定义 */ \
        DEFINE_MSG_MID(I1_UEPS_PID_XSMS)            /* = 5 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */ \
        ...
        DEFINE_MSG_MID(I1_WUEPS_PID_USIM = 20)      /* = 20 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I1_WUEPS_PID_MMC)            /* = 30 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I1_WUEPS_PID_TAF)            /* = 40 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(MSPS_PID_1X_RLAC = 50)       /* = 50 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(CTTF_PID_HRPD_RSPS)          /* = 60 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(DSP_PID_PROCSTUB = 70)       /* = 70 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(UEPS_PID_HSCP    = 80)       /* = 80 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_UEPS_PID_XPDS)            /* = 90 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_WUEPS_PID_USIM)           /* = 101 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(WUEPS_PID_REG)               /* = 110 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I1_MSP_LDSP_PID)             /* = 120 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_UEPS_PID_GRM)             /* = 130 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_WUEPS_PID_RABM)           /* = 140 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_WUEPS_PID_ADMIN)          /* = 150 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(WUEPS_PID_RESERVED_160)      /* RESERVED = 160 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(PS_PID_CSS)                  /* = 170 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_PS_PID_RLC_UL)            /* = 180 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I0_WUEPS_PID_MACDL)          /* = 190 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(UEPS_PID_DHCP)               /* = 200 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(WUEPS_PID_NVIM_FLUSH)        /* = 210 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(WUEPS_PID_CBPCA)             /* = 220 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(MSP_PID_DRX)                 /* = 230 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I2_WUEPS_PID_RABM)           /* = 240 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I2_PS_PID_NAS_COMM = 250)    /* = 250 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I2_UEPS_PID_LL)              /* = 260 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I2_DSP_PID_WAKE)             /* = 270 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I1_PS_PID_RLC_DL)            /* = 280 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(DSP_PID_CSDR_HRPD_SM_AGENT = 290)  /* = 290 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I1_DSP_PID_TLPHY)            /* = 294 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(I2_UEPS_PID_CCM)             /* = 320 */ /* 提醒! 新增多实例PID请加到g_aPsPidModemIdMapTbl, 新增CDMA的PID请加到g_aPidForCdmaTbl */  \
        ...
        DEFINE_MSG_MID(ACPU_PID_PC5_CHQEST)         /* =  */  \
