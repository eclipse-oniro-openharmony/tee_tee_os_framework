#ifndef __SECURE_SERIAL_PLAT__H
#define __SECURE_SERIAL_PLAT__H
...
/* IOMG for UART0 */
//For k3v3 FPGA B040
#define     REG_BASE_IOC                    (0xE8612000)//IOC
