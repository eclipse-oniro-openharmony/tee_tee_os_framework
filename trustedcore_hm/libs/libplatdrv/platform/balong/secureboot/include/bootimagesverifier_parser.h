 ...
 *         on failure - a value from BootImagesVerifier_error.h
 */
DxError_t DxCertParserLoadCertificate(DxSbFlashReadFunc flashRead_func,
				  void *userContext,
 ...
 *         on failure - a value from BootImagesVerifier_error.h
 */
DxError_t DxCertVerifyCertificate(unsigned long hwBaseAddress, uint32_t *pCert, DxSbCertInfo_t *certPkgInfo,
