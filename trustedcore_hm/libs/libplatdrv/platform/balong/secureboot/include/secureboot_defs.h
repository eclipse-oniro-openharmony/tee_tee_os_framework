...
#define DX_SB_MAX_SIZE_OF_ADDITIONAL_DATA	128
...
typedef uint32_t HASH_Result_t[HASH_RESULT_SIZE_IN_WORDS]__attribute__((aligned(OS_CACHE_LINE_SIZE)));
typedef uint32_t DxSbCertPubKeyHash_t[HASH_RESULT_SIZE_IN_WORDS]__attribute__((aligned(OS_CACHE_LINE_SIZE)));
typedef uint32_t DxSbCertSocId_t[HASH_RESULT_SIZE_IN_WORDS]__attribute__((aligned(OS_CACHE_LINE_SIZE)));
