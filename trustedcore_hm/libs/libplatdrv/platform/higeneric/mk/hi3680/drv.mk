...
inc-flags += -I$(SOURCE_DIR)/platform \
	    ...
	    -I$(SOURCE_DIR)/platform/kirin/include/platform/kirin980
...
CFILES += platform/kirin/secmem/driver/sec/kirin980_ddr_autofsgt_proxy_secure_os.c
...
CFILES += platform/common/display2.0/reg_dfc/hisi_dss_dfc_kirin980_base.c \
          ...
          platform/common/display2.0/reg_ldi/hisi_dss_ldi_kirin980_base.c \
          ...
          platform/common/display2.0/channel_data/hisi_dss_channel_data_kirin980_base.c \
          platform/common/display2.0/hdcp/hisi_hdcp_common.c \
          platform/common/display2.0/hdcp/hisi_hdcp_esm.c
...
inc-flags += -DCONFIG_MODEM_ASLR

# inse
inc-flags += -DSE_VENDOR_HISEE
# I2C ESE  only use in kirin980
