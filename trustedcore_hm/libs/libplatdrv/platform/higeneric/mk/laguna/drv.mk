...
inc-flags += -I$(SOURCE_DIR)/platform \
	    ...
	    -I$(SOURCE_DIR)/platform/kirin/include/platform/laguna
...
inc-flags += -I$(SOURCE_DIR)/platform/kirin/npu_v100/platform/hi6285

#platform module
CFILES += platform/kirin/npu_v100/platform/hi6285/npu_adapter.c
...
CFILES += platform/kirin/secmem/driver/sec/laguna_ddr_autofsgt_proxy_secure_os.c
CFILES += platform/kirin/secmem/driver/sec/laguna/sec_region.c
CFILES += platform/kirin/secmem/driver/sec/laguna/tzmp2.c
ifeq ($(COMPILE_SEC_DDR_TEST),true)
CFILES += platform/kirin/secmem/driver/sec/laguna/sec_region_test.c
...
inc-flags += -DCONFIG_DSS_TYPE_LAGUNA
