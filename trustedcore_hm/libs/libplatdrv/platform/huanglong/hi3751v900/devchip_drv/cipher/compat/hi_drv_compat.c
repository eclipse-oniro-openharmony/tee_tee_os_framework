                             ...
                             hi_u32 data_length, hi_cipher_data_dir dir)
{
    ...
    return kapi_symc_crypto(handle, input, output, data_length,
        SYMC_OPERATION_ENCRYPT, HI_FALSE, dir);
}
                             ...
                             hi_u32 data_length, hi_cipher_data_dir dir)
{
    ...
    return kapi_symc_crypto(handle, input, output, data_length,
        SYMC_OPERATION_ENCRYPT, HI_TRUE, dir);
}
...
{
    compat_addr phy_addr;

    hi_log_check_param(ctrl == HI_NULL);

    ADDR_U64(phy_addr) = ctrl->a_phy_addr;
    ...
    return kapi_symc_config(ctrl->handle, /* handle or softid */
                            ...
                            phy_addr, ctrl->a_len, ctrl->tag_len);
}
