...
static int cryp_ifep_rsa_exp_mod(mbedtls_mpi *x, const mbedtls_mpi *a,
                                 const mbedtls_mpi *e, const mbedtls_mpi *n_in,
                                 mbedtls_mpi *_rr)
{
    hi_u32 module_len;
    hi_u8 *buf = HI_NULL;
    ...
    module_len = mbedtls_mpi_size(n_in);
