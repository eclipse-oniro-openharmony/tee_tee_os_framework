...
static int ecp_mod_p521( mbedtls_mpi *N )
{
    ...
    if( M.n > P521_WIDTH + 1 )
        M.n = P521_WIDTH + 1;
    M.p = Mp;
    MBEDTLS_MPI_CHK( memcpy_s( Mp, sizeof( Mp ), N->p + P521_WIDTH - 1, M.n * sizeof( mbedtls_mpi_uint ) ) );
...
static int ecp_mod_p255( mbedtls_mpi *N )
{
    ...
    M.p = Mp;
    MBEDTLS_MPI_CHK( memset_s( Mp, sizeof( Mp ), 0, sizeof( Mp ) ) );
    MBEDTLS_MPI_CHK( memcpy_s( Mp, sizeof( Mp ), N->p + P255_WIDTH - 1,
        M.n * sizeof( mbedtls_mpi_uint ) ) );
...
static int ecp_mod_p448( mbedtls_mpi *N )
{
    ...
    M.p = Mp;
    MBEDTLS_MPI_CHK( memset_s( Mp, sizeof( Mp ), 0, sizeof( Mp ) ) );
    MBEDTLS_MPI_CHK( memcpy_s( Mp, sizeof( Mp ), N->p + P448_WIDTH,
        M.n * sizeof( mbedtls_mpi_uint ) ) );
    ...
    Q = M;
    Q.p = Qp;
    MBEDTLS_MPI_CHK( memcpy_s( Qp, sizeof( Qp ), Mp, sizeof( Qp ) ) );
                                   ...
                                   size_t adjust, size_t shift, mbedtls_mpi_uint mask )
{
    ...
    if( M.n > p_limbs + adjust )
        M.n = p_limbs + adjust;
    MBEDTLS_MPI_CHK( memset_s( Mp, sizeof( Mp ), 0, sizeof( Mp ) ) );
    MBEDTLS_MPI_CHK( memcpy_s( Mp, sizeof( Mp ), N->p + p_limbs - adjust,
        M.n * sizeof( mbedtls_mpi_uint ) ) );
    if( shift != 0 )
