...
#define reg_mcu_sec_intr_mask(x)   (((x) & 0x1) << 0)
#define REG_MCU_SEC_INTR_MASK      (0x1 << 0)
#define reg_pwd_sec_intr_mask(x)   (((x) & 0x1) << 1)
#define REG_PWD_SEC_INTR_MASK      (0x1 << 1)

#define REG_HDCP2X_SEC_INTR_B0     0x1C080
#define REG_HDCP2X_SEC_INTR_B1     0x1C084
#define REG_HDCP2X_SEC_MASK_B0     0x1C088
#define REG_HDCP2X_SEC_MASK_B0_ALL 0x7f       /* see enum hdmitx_mcu_sec_intr_type, use bit[5:0] */
...
#endif /* __HAL_HDMITX_HDCP_REG_H__ */
