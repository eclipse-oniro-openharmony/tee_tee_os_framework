...
#ifndef __TEE_DRV_KLAD_STRUCT_H__
#define __TEE_DRV_KLAD_STRUCT_H__
...
#define get_klad_type(type)          (((type) >> 8) & 0xff)
 ...
 */
#define HI_KLAD_TYPE_OEM_TA      hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x02)
 ...
 * Keyladder algorithm use AES, target engine is MCipher and target engine algorithm is AES.
 */
#define HI_KLAD_TYPE_HISI_TA     hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x03)
 ...
 * Keyladder algorithm use AES, target engine is MCipher and target engine algorithm is AES.
 */
#define HI_KLAD_TYPE_CA_TA       hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x04)
 ...
 */
#define HI_KLAD_TYPE_R2R         hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x01)
 ...
 * Keyladder algorithm use AES, target engine is MCIPHER and target engine algorithm is AES.
 */
#define HI_KLAD_TYPE_SECSTORGE  hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x05)
 ...
 * Keyladder algorithm use AES, target engine is MCIPHER and target engine algorithm is AES.
 */
#define HI_KLAD_TYPE_VMCU      hi_klad_instance(HI_CA_ID_BASIC, HI_ROOTKEY_R2R, HI_KLAD_COM, 0x06)
...
*/
#define HI_KLAD_NAGRA_TYPE_CSA2   hi_klad_instance(HI_CA_ID_NAGRA, HI_ROOTKEY_CSA2, HI_KLAD_COM, 0x01)
...
*/
#define HI_KLAD_NAGRA_TYPE_CSA3   hi_klad_instance(HI_CA_ID_NAGRA, HI_ROOTKEY_CSA3, HI_KLAD_COM, 0x02)
...
*/
#define HI_KLAD_NAGRA_TYPE_AES    hi_klad_instance(HI_CA_ID_NAGRA, HI_ROOTKEY_AES, HI_KLAD_COM, 0x03)
...
*/
#define HI_KLAD_NAGRA_TYPE_TDES   hi_klad_instance(HI_CA_ID_NAGRA, HI_ROOTKEY_TDES, HI_KLAD_COM, 0x04)
...
*/
#define HI_KLAD_NAGRA_TYPE_FPK    hi_klad_instance(HI_CA_ID_NAGRA, HI_ROOTKEY_NULL, HI_KLAD_FP, 0x01)
...
typedef struct {
    ...
    hi_klad_key_secure_config key_sec_cfg; /* the content key security configuration. */
} hi_klad_attr;
...
typedef struct {
    ...
    hi_u8 key[HI_KLAD_MAX_KEY_LEN];
    hi_u32 enc_key_size;
    hi_u8 enc_key[HI_KLAD_MAX_KEY_LEN];
} hi_klad_fp_key;
...
#endif /* __TEE_DRV_KLAD_STRUCT_H__ */
