...
struct klad_r_fp_hkl_ops {
    ...
    hi_s32(*attach)(struct klad_r_com_hkl *com_hkl, struct klad_r_fp_hkl *fp_hkl);
    hi_s32(*rootkey_process)(struct klad_r_fp_hkl *fp_hkl);
    hi_s32(*start)(struct klad_r_fp_hkl *fp_hkl, hi_klad_fp_entry *instance);
    hi_s32(*route)(struct klad_r_fp_hkl *fp_hkl);
...
struct klad_r_fp_hkl {
    ...
    hi_bool                    rkp_ready;
    struct klad_r_com_hkl      *com_obj; /* Associate ta keyladder to a common keyladder */
...
struct klad_mgmt {
    ...
    hi_mutex                com_hkl_lock;
    spinlock_t              com_hkl_lock2;
    hi_u32                  com_hkl_cnt;
