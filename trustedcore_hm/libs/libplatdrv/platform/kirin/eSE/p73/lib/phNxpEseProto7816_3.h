...
#define INVALID_OS_VERSION  0xFF
#define OS_VERSION_4_0 1
#define OS_VERSION_5_1 2
#define OS_VERSION_5_2 3
#define OS_VERSION_5_2_2 4
/*!
...
#define GET_DELAY_ERROR_RECOVERY()  (7 * DELAY_ERROR_RECOVERY_1_MS)

#define MODE_MAX_CNT 4
#define GET_MODE_DELAY (100 * DELAY_ERROR_RECOVERY_1_MS)
//#define GET_DELAY_ERROR_RECOVERY()  (10 * DELAY_ERROR_RECOVERY_1_MS / 500 * 7)
 ...
 */
#define PH_PROTO_7816_FRAME_RETRY 3
