 ...
 *
 */
void* phPalEse_memset(void* buff, int val, uint32_t len);
 ...
 *
 */
void* phPalEse_memcpy(void* dest, const void* src, uint32_t len);
 ...
 *
 */
void* phPalEse_calloc(uint32_t dataType, uint32_t size);
