 ...
 * vote_id: MSPC power vote id(Just used in MSPC)
 * atr: SE's atr buffer
...
/*
 * id: pointer to increasing vote id
 * return: success --- HISEE_SUCCESS
 *         failure --- HISEE_FAILURE
 */
int inse_connect(void *id);

/*
 * id: pointer to decreasing vote id
 * return: success --- HISEE_SUCCESS
 *         failure --- HISEE_FAILURE
 */
