...
#define MSPC_WAIT_READY_TIMEOUT     7 /* 7s */
/* MSPC_POWER_OFF_DELAY cannot greater than MSPC_WAIT_READY_TIMEOUT */
#define MSPC_POWER_OFF_DELAY        MSPC_WAIT_READY_TIMEOUT

/* must sync with libs/libmspcore and ta_common/src/hisi mspc_ext_api.h */
enum mspc_vote_id {
