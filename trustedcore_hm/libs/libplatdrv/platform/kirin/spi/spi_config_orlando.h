 ...
 * Create: 2018-09-04
 */
#ifndef __SPI_CONFIG_ORLANDO_H__
#define __SPI_CONFIG_ORLANDO_H__
...
static struct spi_resource spi_res[] = {
	...
	[1] = {
		...
		.gpios[0] = {
			.gpio = 212,
			.function[SPI_GPIO_CFG_DEFAULT] = GPIOMUX_M2,
			.function[SPI_GPIO_CFG_IDLE] = GPIOMUX_M0,
			.pulltype[SPI_GPIO_CFG_DEFAULT] = GPIOMUX_NOPULL,
			.pulltype[SPI_GPIO_CFG_IDLE] = GPIOMUX_NOPULL,
		},
	...
	[3] = {
		...
		.spi_clk_gate_bit = 13,
		.reg_clk_gate_enable = SOC_ACPU_PERI_CRG_BASE_ADDR + 0xF4,
		.spi_reset_bit = 9,
