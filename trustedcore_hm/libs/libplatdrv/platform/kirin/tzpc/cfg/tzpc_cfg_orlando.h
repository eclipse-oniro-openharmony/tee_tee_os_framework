...
#ifndef __TZPC_CFG_ORLANDO__
#define __TZPC_CFG_ORLANDO__
...
TZPC_BIT_DEF tzpc_tbl[] = {
	...
	{ TZPC_IOC_SUB_REGION8, TZPC_TABLE_PERI, 0, 16, TZPC_UNSEC },
	/* tzpcdecprot1 */
	...
	/* tzpcdecprot2 */
	{ TZPC_GPIO20, TZPC_TABLE_PERI, 2, 2, TZPC_UNSEC },
	{ TZPC_GPIO21, TZPC_TABLE_PERI, 2, 3, TZPC_UNSEC },
	...
	{ TZPC_GPU_ENABLE_FIREWALL, TZPC_TABLE_PERI, 2, 16, TZPC_UNSEC },
	{ TZPC_GPU_ERR_RESP, TZPC_TABLE_PERI, 2, 17, TZPC_UNSEC },
	{ TZPC_GPU_sel0_or_el2_select, TZPC_TABLE_PERI, 2, 18, TZPC_SEC },
	{ TZPC_gpu_slave_secure_property_0, TZPC_TABLE_PERI, 2, 20, TZPC_UNSEC },
	{ TZPC_gpu_slave_secure_property_1, TZPC_TABLE_PERI, 2, 21, TZPC_UNSEC },
	/* tzpcdecprot3 */
	{ TZPC_GPIO0_EMMC, TZPC_TABLE_PERI, 3, 24, TZPC_UNSEC },
	{ TZPC_GPIO1_EMMC, TZPC_TABLE_PERI, 3, 25, TZPC_UNSEC },
	{ TZPC_SD3, TZPC_TABLE_PERI, 3, 28, TZPC_UNSEC },
	{ TZPC_SDIO0, TZPC_TABLE_PERI, 3, 29, TZPC_UNSEC },
	{ TZPC_MMC0_SYS_CTRL, TZPC_TABLE_PERI, 3, 30, TZPC_UNSEC },
	/* tzpcdecprot4 */
	{ TZPC_EMMC5_1PHY, TZPC_TABLE_PERI, 4, 0, TZPC_UNSEC },
	...
	{ TZPC_SPI1, TZPC_TABLE_PERI, 4, 19, TZPC_UNSEC }, /* reboot */
	...
	{ TZPC_I3C4, TZPC_TABLE_PERI, 4, 24, TZPC_UNSEC },
	...
	{ TZPC_IOC_MMC1, TZPC_TABLE_PERI, 4, 31, TZPC_UNSEC },
	/* tzpcdecprot5 */
	{ TZPC_PMU_SSI0, TZPC_TABLE_PERI, 5, 1, TZPC_SEC },
	{ TZPC_TSENSORC, TZPC_TABLE_PERI, 5, 2, TZPC_SEC },
	{ TZPC_PMC, TZPC_TABLE_PERI, 5, 3, TZPC_UNSEC }, /* panic */
	{ TZPC_UART6, TZPC_TABLE_PERI, 5, 4, TZPC_UNSEC },
	{ TZPC_CPU_PERI_CRG_SUB_REGION1, TZPC_TABLE_PERI, 5, 6, TZPC_SEC },
	...
	{ TZPC_CPU_PERI_CRG_SUB_REGION0_REGION3, TZPC_TABLE_PERI, 5, 15, TZPC_UNSEC },
	{ TZPC_LP_RAM, TZPC_TABLE_PERI, 5, 17, TZPC_SEC },
	{ TZPC_CPU_PERI_CRG_SUB_REGION2, TZPC_TABLE_PERI, 5, 19, TZPC_SEC },
	...
	{ TZPC_MASTER_EMMC5_1, TZPC_TABLE_PERI, 6, 24, TZPC_UNSEC },
	/* tzpcdecprot7 */
	{ TZPC_PSAM_NSEC_SUB_REGION0, TZPC_TABLE_PERI, 7, 0, TZPC_UNSEC },
	{ TZPC_IPF_NSEC_SUB_REGION0, TZPC_TABLE_PERI, 7, 1, TZPC_UNSEC },
	{ TZPC_PSAM_SUB_REGION1, TZPC_TABLE_PERI, 7, 2, TZPC_SEC },
	...
	/* tzpcdecprot8 */
	{ TZPC_ISP_ENABLE_FIREWALL, TZPC_TABLE_PERI, 8, 0, TZPC_UNSEC },
	{ TZPC_ISP_ERR_RESP, TZPC_TABLE_PERI, 8, 1, TZPC_UNSEC },
	{ TZPC_ISP_sel0_el2_select, TZPC_TABLE_PERI, 8, 2, TZPC_SEC },
	{ TZPC_ISP_smmu_firewall_enable, TZPC_TABLE_PERI, 8, 5, TZPC_UNSEC },
	{ TZPC_isp_cfg_0, TZPC_TABLE_PERI, 8, 6, TZPC_UNSEC },
	{ TZPC_isp_cfg_1, TZPC_TABLE_PERI, 8, 7, TZPC_UNSEC },
	{ TZPC_IVP_ENABLE_FIREWALL_SMMU, TZPC_TABLE_PERI, 8, 12, TZPC_UNSEC },
	{ TZPC_IVP_ERR_RESP, TZPC_TABLE_PERI, 8, 13, TZPC_UNSEC },
	{ TZPC_IVP_sel0_el2_select, TZPC_TABLE_PERI, 8, 14, TZPC_SEC },
	{ TZPC_ivp_cfg_firewall_enable, TZPC_TABLE_PERI, 8, 16, TZPC_UNSEC },
	{ TZPC_ivp_cfg_0, TZPC_TABLE_PERI, 8, 17, TZPC_UNSEC },
	{ TZPC_ivp_cfg_1, TZPC_TABLE_PERI, 8, 18, TZPC_UNSEC },
	{ TZPC_ddrc_ENABLE_FIREWALL, TZPC_TABLE_PERI, 8, 20, TZPC_UNSEC },
	{ TZPC_ddrc_ERR_RESP, TZPC_TABLE_PERI, 8, 21, TZPC_UNSEC },
	{ TZPC_ddrc_sel0_el2_select, TZPC_TABLE_PERI, 8, 22, TZPC_SEC },
	{ TZPC_ddrc_mpu_0, TZPC_TABLE_PERI, 8, 24, TZPC_SEC },
	{ TZPC_ddrc_mpu_1, TZPC_TABLE_PERI, 8, 25, TZPC_SEC },
	/* ao_tzpcdecprot0 */
	...
	{ AO_TZPC_SCTRL_SUB_REGION0, TZPC_TABLE_AO, 0, 6, TZPC_UNSEC },
	{ AO_TZPC_SCTRL_SUB_REGION1, TZPC_TABLE_AO, 0, 7, TZPC_UNSEC }, /* reboot */
	{ AO_TZPC_SCTRL_SUB_REGION2, TZPC_TABLE_AO, 0, 8, TZPC_UNSEC }, /* reboot */
	{ AO_TZPC_SCTRL_SUB_REGION3, TZPC_TABLE_AO, 0, 9, TZPC_SEC },
	{ AO_TZPC_SCTRL_SUB_REGION4, TZPC_TABLE_AO, 0, 10, TZPC_SEC },
	{ AO_TZPC_SCTRL_SUB_REGION5, TZPC_TABLE_AO, 0, 11, TZPC_SEC },
	...
	{ AO_TZPC_GPIO18, TZPC_TABLE_AO, 1, 6, TZPC_UNSEC },
	{ AO_TZPC_GPIO19, TZPC_TABLE_AO, 1, 7, TZPC_UNSEC },
	...
	{ AO_TZPC_AO_IOC_SUB_REGION32, TZPC_TABLE_AO, 1, 19, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION33, TZPC_TABLE_AO, 1, 20, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION34, TZPC_TABLE_AO, 1, 21, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION35, TZPC_TABLE_AO, 1, 22, TZPC_SEC },
	{ AO_TZPC_UFS_SYS_CTRL, TZPC_TABLE_AO, 1, 24, TZPC_UNSEC },
	{ AO_TZPC_UFS_CFG, TZPC_TABLE_AO, 1, 25, TZPC_UNSEC },
	{ AO_TZPC_AO_IOC_SUB_REGION36, TZPC_TABLE_AO, 1, 26, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION37, TZPC_TABLE_AO, 1, 27, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION38, TZPC_TABLE_AO, 1, 28, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION39, TZPC_TABLE_AO, 1, 29, TZPC_SEC },
	{ AO_TZPC_AO_IOC_SUB_REGION40, TZPC_TABLE_AO, 1, 31, TZPC_UNSEC },
	/* ao_tzpcdecprot2 */
	...
	{ AO_TZPC_UFS, TZPC_TABLE_AO, 3, 2, TZPC_UNSEC },
};

#endif /* __TZPC_CFG_ORLANDO__ */
