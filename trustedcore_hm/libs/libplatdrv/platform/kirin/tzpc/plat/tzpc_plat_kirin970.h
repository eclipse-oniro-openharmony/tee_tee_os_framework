...
#ifndef __TZPC_PLAT_KIRIN970__
#define __TZPC_PLAT_KIRIN970__
...
enum {
	...
	/*TZPC_SLAVE_G3D_FW_EN,*/               /*bit16*/
	/*TZPC_SLAVE_G3D_FW_ERR_RSP,*/          /*17*/
	TZPC_SLAVE_G3D,		/*18 */
	/*PROT[3]*/
	/*TZPC_SLAVE_PCIE_FW_EN,*/      /*bit8*/
	/*TZPC_SLAVE_PCIE_ERR_RSP,*/            /*bit9*/
	TZPC_SLAVE_PCIE,	/*bit10 */
	/*TZPC_SLAVE_HKMEM_FW_EN,*/      /*bit16*/
	/*TZPC_SLAVE_HKMEM_ERR_RSP,*/           /*bit17*/
	...
	/*PROT[8]*/
	/*TZPC_SLAVE_VIVOBUS_FW_EN,*/    /*bit0*/
	/*TZPC_SLAVE_VIVOBUS_FW_ERR_RSP,*/    /*bit1*/
	TZPC_SLAVE_VIVOBUS,	/*bit2 */
	TZPC_IP_NUM_MAX
};

#endif /* __TZPC_PLAT_KIRIN970__ */