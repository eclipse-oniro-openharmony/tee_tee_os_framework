...
static struct sel_s sel_out_map[] = {
	...
	/* This SEL_OUT is for OVL0_2L-> RSZ -> OVL0 */
	/* OVL0_2L -> OVL0 would not pass through this MUX */
	{DISP_MODULE_UNKNOWN, {DISP_MODULE_OVL0_2L_VIRTUAL0,
