...
#define DISP_REG_RDMA_IN_P_CNT (0x120)
#define DISP_REG_RDMA_IN_LINE_CNT (0x124)
#define DISP_REG_RDMA_OUT_P_CNT (0x128)
#define DISP_REG_RDMA_OUT_LINE_CNT (0x12c)

#define DISP_REG_RDMA_DBG_OUT (0x100)
#define DISP_REG_RDMA_DBG_OUT1 (0x10c)
#define DISP_REG_RDMA_ULTRA_SRC_SEL (0x1a0)
#define DISP_REG_RDMA_GREQ_NUM_SEL (0x1a4)
#define DISP_REG_RDMA_GREQ_URG_NUM_SEL (0x1a8)
