...
#define IMU_PGD_ALIGN                          ((64*1024)-1)
...
#define F_PGD_BIT34_BIT                        F_BIT_SET(5)
...
#define F_PGD_PA_PAGETABLE_MSK                 F_MSK_L(34, 10)
#define F_PGD_PA_PAGETABLE_SET(val)            F_VAL_L(val, 34, 10)
#define F_PGD_PA_SECTION_MSK                   F_MSK_L(34, 20)
#define F_PGD_PA_SECTION_SET(val)              F_VAL_L(val, 34, 20)
#define F_PGD_PA_SUPERSECTION_MSK              F_MSK_L(34, 24)
#define F_PGD_PA_SUPERSECTION_SET(val)         F_VAL_L(val, 34, 24)
