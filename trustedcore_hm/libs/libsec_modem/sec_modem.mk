...
inc-flags += -I$(SECURE_OS_DIR)/libs/libsec_modem/old_header/
inc-flags += -I$(SECURE_OS_DIR)/sys_libs/libdrv_frame/include/
inc-flags += -I$(SECURE_OS_DIR)/libs/libplatdrv/platform/kirin/secureboot
...
include $(SECURE_OS_DIR)/libs/libsec_modem/teeos/modem_build.mk
