...
struct file_stat_entry {
    ...
    { "/ssa.elf", 9, 1001, 00040 },
    { "/platdrv.elf", 4, 1001, 07005 },
    { "/drv_timer.elf", 5, 1001, 07005 },
    { "/keymaster.elf", 7, 1001, 00040 },
    { "/gatekeeper.elf", 8, 1001, 00040 },
    { "/storage.elf", 10, 1001, 00040 },
    { "/antiroot.elf", 11, 1001, 00040 },
    { "/secboot.elf", 12, 1001, 00040 },
    { "/sem.elf", 14, 1001, 00040 },
    { "/README", 15, 15, 00000 },
    { "/hm_qemu_test_a32", 0, 1001, 07005 },
    { "/hm_qemu_test", 0, 1001, 07005 },
    { "/kernel_debugger", 0, 1001, 07005 },
    { "/perf.elf", 16, 1001, 07005 },
    { "/perf", 16, 1001, 07005 },
    { "/vdec.elf", 17, 1001, 00040 },
    { "/secmem.elf", 18, 1001, 00040 },
    { "/hivcodec.elf", 19, 1001, 00040 },
    { "/file_encry.elf", 20, 20, 00040 },
    /*
     ...
     */
    { "/tee_drv_server.elf", 21, 1002, 07005 },
