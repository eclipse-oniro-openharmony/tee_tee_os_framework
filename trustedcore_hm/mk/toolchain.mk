...
ifeq ("$(compiler-rt)", "exist")
	LIBCOMPILER_RT_BUILTINS := $(COMPILER_RT_DIR)/arm-linux-ohosmusl/libclang_rt.builtins.a
else
...
ifeq ("$(compiler-rt)", "exist")
	LIBCOMPILER_RT_BUILTINS := $(COMPILER_RT_DIR)/aarch64-linux-ohosmusl/libclang_rt.builtins.a
else
