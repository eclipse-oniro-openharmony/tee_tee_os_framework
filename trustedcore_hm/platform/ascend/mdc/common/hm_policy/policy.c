...
AC_DEFINE_SUBJ_BEG(ta_add)
    ...
    { AC_SID_TEE_SERVICE_HSM, 0, NULL },
    { AC_SID_TEE_SERVICE_HSM_RPMBKEY, 0, NULL },
    { AC_SID_TEE_SERVICE_HSM_UPGRADE, 0, NULL },
    { AC_SID_TEE_SERVICE_SSA, 0, NULL },
    { AC_SID_TEE_SERVICE_HUK, 0, NULL },
    { AC_SID_TEE_SERVICE_HSM_BBOX, 0, NULL },
    { AC_SID_TEE_SERVICE_HSM_EFUSE, 0, NULL },
    { AC_SID_TEE_SERVICE_HSM_FLASH, 0, NULL },
...
static const sid_t g_map2task_service_hsmsrv_objs[] = {
    AC_SID_TEE_SERVICE_HSM,
};

static const struct ac_static_object g_map2task_service_hsmsrv_acobjs = {
    sizeof(sid_t), ARRAY_SIZE(g_map2task_service_hsmsrv_objs), g_map2task_service_hsmsrv_objs
};
...
AC_DEFINE_SUBJ_BEG(map2task)
    ...
    { AC_SID_TEE_SERVICE_HSM, ARRAY_SIZE(g_map2task_service_hsmsrv_objs), &g_map2task_service_hsmsrv_acobjs },
