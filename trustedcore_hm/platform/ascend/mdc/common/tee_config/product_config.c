...
struct call_info g_kernel_ca_whitelist[] = {
    ...
    { "ufs_rpmb_key", true, 0, INVALID_PID, TEE_SERVICE_HSM_RPMBKEY },
    ...
    { "hsm-ca-fuzz-test", true, 0, INVALID_PID, TEE_SERVICE_HSM_RPMBKEY },
...
const struct task_info_st g_product_builtin_task_infos[] = {
    ...
    { TEE_SERVICE_HSM_RPMBKEY, HSM_RPMBKEY_NAME, "/rpmb_key.elf", HM_PRIO_TEE_TA, true },
...
#endif
#ifdef TEE_SUPPORT_KMS
    { TEE_SERVICE_KMS, KMS_STACK_SIZE, KMS_HEAP_SIZE, true, true, true, true, "gpd.ta.api_level:3", 19 },
#endif
    { TEE_SERVICE_HSM_UPGRADE, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, true, false, false, NULL, 0 },
    { TEE_SERVICE_HSM_RPMBKEY, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, true, false, false, NULL, 0 },
...
#endif
    { TEE_SERVICE_HSM_UPGRADE, 0, HSM_GROUP_PERMISSION | FLASH_GROUP_PERMISSION | TIMER_GROUP_PERMISSION |
        HSM_EFUSE_GROUP_PERMISSION},
    { TEE_SERVICE_HSM_RPMBKEY, 0, HSM_GROUP_PERMISSION },
    { TEE_SERVICE_HSM_EFUSE, 0, HSM_EFUSE_GROUP_PERMISSION | HSM_GROUP_PERMISSION },
    { TEE_SERVICE_HSM_FLASH, 0, FLASH_GROUP_PERMISSION | HSM_GROUP_PERMISSION },
