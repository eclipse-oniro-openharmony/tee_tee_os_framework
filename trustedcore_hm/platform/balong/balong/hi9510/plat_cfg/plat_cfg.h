...
#ifndef PLAT_CFG_H
#define PLAT_CFG_H
#define PROTECTED_REGION_START1     0x500000
#define PROTECTED_REGION_END1       0x700000
...
#define HI_CS_TSP_REG_BASE 0xF5800000
#define HI_CS_TSP_REG_SIZE 0x200000

#define HI_ES_TSP_REG_BASE 0xE1800000
#define HI_ES_TSP_REG_SIZE 0x200000
#define TIMER1_BASE                 0xEDF19000
#define TIMER1_BASE_SIZE            0x1000
#define TIMER6_BASE                 0xEDF19000
...
#define TEEOS_MEM_SIZE              0xC00000
#define SHMEM_SIZE                  0x1000
#define SHMEM_OFFSET                (TEEOS_MEM_SIZE - SHMEM_SIZE)
#define GIC_V3_DIST_ADDR            0xE6C00000
#define GIC_V3_REDIST_ADDR          0xE6C40000
#define GIC_DIST_PAGENUM            16
#define GIC_REDIST_PAGENUM          256
#define GIC_REDIST_NUM              1
#define GIC_REDIST_MEMSIZE          0x20000
#define SPI_NUM                     72
#define EICC_PERI_REGBASE_VADDR     0xE5040000
#define EICC_MDM0_REGBASE_VADDR     0xE0B00000
#define EICC_REGBASE_SIZE           0x8000
#endif
