# hi9510 product config compile rules
...
BLOCKLIST += ccdriver_lib libdxcc cc_driver efuse eicc200 icc memory  memory_layout modem msg non_support platform sec_call sec_dump secureboot sysboot trng
export BLOCKLIST
