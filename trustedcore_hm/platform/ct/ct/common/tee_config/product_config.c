...
#define STACK_PERM 8
#define HEAP_PERM  7 /* more for crl */
...
const struct ta_permission g_ta_permission_config[] = {
    { TEE_SERVICE_MINITPM, 0, TPM_GROUP_PERMISSION },
    { TEE_SERVICE_DIM,     0, DIM_GROUP_PERMISSION },
    { TEE_SERVICE_FTPM,    0, TPM_GROUP_PERMISSION },
