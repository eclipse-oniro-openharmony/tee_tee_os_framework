...
AC_DEFINE_SUBJ_BEG(ta_add)
    ...
    { AC_SID_SUPER, 0, NULL },
#endif
    { AC_SID_TEESMCMGR, 0, NULL }, { AC_SID_TALDR, 0, NULL }, { AC_SID_GTASK, 0, NULL }, { AC_SID_PLATDRV, 0, NULL },
    { AC_SID_DRV_TIMER, 0, NULL }, { AC_SID_HMCCMGR, 0, NULL }, T_POLICY(ta_add){ AC_SID_TEE_SERVICE_RPMB, 0, NULL },
