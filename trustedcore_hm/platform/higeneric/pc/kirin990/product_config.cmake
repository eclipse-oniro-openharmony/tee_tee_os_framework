...
if ("${CONFIG_SUPPORT_64BIT}" STREQUAL "true")
    list(APPEND PRODUCT_RELEASE_64 file_encry.elf bdkernel.elf)
else()
    list(APPEND PRODUCT_RELEASE_64 file_encry.elf bdkernel.elf)
    list(APPEND PRODUCT_RELEASE_32 file_encry.elf bdkernel.elf)
endif()

if ("${CONFIG_DRV_64BIT}" STREQUAL "false")
    list(APPEND PRODUCT_APPS_32 file_encry.elf bdkernel.elf)
endif()
if ("${CONFIG_DRV_64BIT}" STREQUAL "true")
    list(APPEND PRODUCT_APPS_64 file_encry.elf bdkernel.elf)
endif()
