...
static const taskmap2task_ac_req_t g_taskmap2task_service_vltmm_objs[] = {
    ...
    { AC_SID_TEE_SERVICE_VLTMM_SRV, AC_SID_TEE_DF_AC_SERVICE },
#else
    { AC_SID_TEE_SERVICE_VLTMM_SRV, AC_SID_TEE_SERVICE_VLTMM_SRV }, /* place holder */
#endif
};
...
#endif
#if (TRUSTEDCORE_CHIP_CHOOSE == WITH_CHIP_BALTIMORE)
    { AC_SID_PLATDRV, AC_SID_TEE_SERVICE_HIVCODEC_SR },
#else
    { AC_SID_ALL, AC_SID_PLATDRV }, /* place holder */
#endif
};
...
#ifdef CONFIG_SYSMGR_DEBUG_VREGION_DUMP
{ AC_SID_GTASK, 0, NULL },
#endif
...
static const sid_t g_map2task_platdrv_objs[] = {
    ...
    AC_SID_TEE_SERVICE_HIVCODEC_SR,
#else
    AC_SID_PLATDRV,          /* place holder */
    AC_SID_PLATDRV,          /* place holder */
    AC_SID_PLATDRV,          /* place holder */
