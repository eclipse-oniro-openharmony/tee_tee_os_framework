...
export CONFIG_DRIVER_DYN_MOD := true
...
ifneq ($(filter $(TARGET_BOARD_PLATFORM), baltimore denver burbank laguna), )
...
product_apps += $(OUTPUTDIR)/../../../tee_os_kernel/build/arm/test_service/test_service.elf \
		$(OUTPUTDIR)/../../../tee_os_kernel/build/arm/test_inner_ta/test_inner_ta.elf
endif
ifeq ($(CONFIG_TEST_INNER_SERVICE_64BIT),true)
product_apps += $(OUTPUTDIR)/../../../tee_os_kernel/build/arm/test_service_a64/test_service_a64.elf \
		$(OUTPUTDIR)/../../../tee_os_kernel/build/arm/test_inner_ta_a64/test_inner_ta_a64.elf
endif
