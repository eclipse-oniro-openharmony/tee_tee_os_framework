...
const struct drvlib_load_caller_info g_drvlib_load_caller_info[] = {
#ifdef DEF_ENG
    { TEE_SERVICE_UT, "platdrv_libdemo.so" },
    { TEE_SERVICE_ECHO, "platdrv_libdemo.so" },
    { TEE_SERVICE_UT, "platdrv_libdemo_dependent.so" },
    { TEE_SERVICE_ECHO, "platdrv_libdemo_dependent.so" },
#endif
#ifdef TEE_SUPPORT_MODEM_DYN_LOAD
    { TEE_SERVICE_SECBOOT, "platdrv_libsec_modem.so" },
#endif
};

const uint32_t g_drvlib_load_caller_num = sizeof(g_drvlib_load_caller_info) / sizeof(g_drvlib_load_caller_info[0]);

uint32_t get_drvlib_load_caller_nums(void)
{
    return g_drvlib_load_caller_num;
}

const struct drvlib_load_caller_info *get_drvlib_load_caller_infos(void)
{
    return g_drvlib_load_caller_info;
}

static const struct dynamic_mem_uuid_item g_dynamic_mem_uuid_configs[] = {
#ifdef DEF_ENG
    { CONFIGID_UT, UT_MEM_LEN, TEE_SERVICE_UT, DDR_SEC_EID },
    { CONFIGID_TEST_DYNION, TEST_DYNION_MEM_LEN, TEE_SERVICE_TEST_DYNION, DDR_SEC_FACE },
#endif
#ifdef TEE_SUPPORT_SECIDENTIFICATION
    { CONFIGID_EID1, EID1_MEM_LEN, TEE_SECIDENTIFICATION1, DDR_SEC_EID },
    { CONFIGID_EID3, EID3_MEM_LEN, TEE_SECIDENTIFICATION3, DDR_SEC_EID },
#endif
#ifdef TEE_SUPPORT_AI_DYN_ION
    { CONFIGID_AI, HIAI_RUNNING_PHYMEM_SIZE, TEE_SERVICE_AI, DDR_SEC_FACE },
    { CONFIGID_AI_TINY, AI_TINY_MEM_SIZE, TEE_SERVICE_AI_TINY, DDR_SEC_FACE },
#endif
};
...
#ifdef TEE_SUPPORT_AI_STATIC_ION
    { HISI_RESERVED_TD_HIAI_RUNNING_PHYMEM_BASE, HISI_RESERVED_TD_HIAI_RUNNING_PHYMEM_SIZE,
      TEE_SERVICE_AI, PRI_PP_MEM_TAG }, /* memory 23.5M */
    { HISI_RESERVED_TD_HIAI_PAGETABLE_PHYMEM_BASE, HISI_RESERVED_TD_HIAI_PAGETABLE_PHYMEM_SIZE,
      TEE_SERVICE_AI, PT_MEM_TAG }, /* page table 1.5M */
#endif
};
...
struct call_info g_kernel_ca_whitelist[] = {
    ...
    { "vltmm", true, 0, INVALID_PID, TEE_SERVICE_SECMEM },
#endif
    { "ufs_key_restore", true, 0, INVALID_PID, TEE_SERVICE_FILE_ENCRY },
#ifndef TEE_HIVCODEC_DYNAMIC_TA
    { "/vendor/bin/hw/android.hardware.media.omx@1.0-service", true, 0, INVALID_PID, TEE_SERVICE_HIVCODEC },
#else
    { "/vendor/bin/hw/android.hardware.media.omx@1.0-service", true, 0, INVALID_PID, TEE_SERVICE_HIVCODEC_SR },
#endif
    { "/dev/bdkernel_ca", true, 0, INVALID_PID, TEE_SERVICE_BDKERNEL },
    { "/dev/hwsdp_ca", true, 0, INVALID_PID, TEE_SERVICE_HWSDP },
};
...
const struct task_info_st g_product_builtin_task_infos[] = {
    ...
    { TEE_SERVICE_HWSDP, HWSDP_TASK_NAME,  "/hwsdp.elf",    HM_PRIO_TEE_TA, false },
...
#else
    {TEE_SERVICE_HIVCODEC_SR, HIVCODEC_SR_TASK_NAME, "/hivcodec_sr.elf",   HM_PRIO_TEE_TA, false},
#endif
    { TEE_SERVICE_SECMEM, SECMEM_TASK_NAME,      "/secmem.elf", HM_PRIO_TEE_TA, false },
#ifdef TEE_SUPPORT_VLTMM_SRV
    { TEE_SERVICE_VLTMM_SRV, VLTMMSRV_TASK_NAME,      "/vltmm_service.elf", HM_PRIO_TEE_TA, false },
#endif
...
#endif
#ifdef DEF_ENG
#ifdef TEST_INNER_SERVICE_32BIT
    { TEE_INNER_TEST_TA, TEST_INNER_TA_TASK_NAME,  "/test_inner_ta.elf",  HM_PRIO_TEE_TA, false },
    { TEE_INNER_TEST_SERVICE, TEST_SERVICE_TASK_NAME,  "/test_service.elf",  HM_PRIO_TEE_TA, false },
#elif TEST_INNER_SERVICE_64BIT
    { TEE_INNER_TEST_TA, TEST_INNER_TA_TASK_NAME_A64,  "/test_inner_ta_a64.elf",  HM_PRIO_TEE_TA, true },
    { TEE_INNER_TEST_SERVICE, TEST_SERVICE_TASK_NAME_A64,  "/test_service_a64.elf",  HM_PRIO_TEE_TA, true },
#endif
#endif
};
...
#define HEAP_PERM  3
    ...
    { TEE_SERVICE_HWSDP, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, true, false, false, NULL, 0 },
...
#else
    { TEE_SERVICE_HIVCODEC_SR, DEFAULT_HIVCODEC_STACK_SIZE, DEFAULT_HIVCODEC_HEAP_SIZE, true, false, false,
      false, NULL, 0 },
#endif
#endif
...
#endif
#ifdef DEF_ENG
#if (defined TEST_INNER_SERVICE_64BIT) || (defined TEST_INNER_SERVICE_32BIT)
    { TEE_INNER_TEST_SERVICE, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, true, false, false, NULL, 0 },
    { TEE_INNER_TEST_TA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, true, false, false, NULL, 0 },
#endif
#endif
};
...
const struct ta_permission g_ta_permission_config[] = {
    ...
    { TEE_SERVICE_STRONGBOX, 0, MSPC_GROUP_PERMISSION | TIMER_GROUP_PERMISSION },
#ifdef TEE_SUPPORT_ATTESTATION_TA
    { TEE_SERVICE_ATTESTATION_TA, 0, GENERAL_GROUP_PERMISSION },
#endif
    { TEE_SERVICE_VDEC, 0, VDEC_GROUP_PERMISSION },
    { TEE_CHINADRM_2, 0, VDEC_GROUP_PERMISSION | GENERAL_GROUP_PERMISSION | MSPE_VIDEO_GROUP_PERMISSION},
...
/* dymanic tasks */
    ...
    { TEE_DF_AC_SERVICE, 0, FR_GROUP_PERMISSION | SECMEM_GROUP_PERMISSION },
    ...
    { TEE_SERVICE_EID_U3, 0,
      SE_GROUP_PERMISSION | FR_GROUP_PERMISSION | TIMER_GROUP_PERMISSION |
          HWIMSG_GROUP_PERMISSION  | SECMEM_GROUP_PERMISSION },
    ...
    { TEE_SERVICE_DRM_GRALLOC, 0, SECMEM_GROUP_PERMISSION | IVP_GROUP_PERMISSION },
#else
    ...
    { TEE_SERVICE_PRIP, 0, PRIP_GROUP_PERMISSION},
#ifdef TEE_SUPPORT_SECISP
...
#endif
    { TEE_SERVICE_AI_TINY, 0, TIMER_GROUP_PERMISSION | AI_GROUP_PERMISSION | SECMEM_GROUP_PERMISSION |
      DYNAMIC_ION_PERMISSION | NPU_GROUP_PERMISSION },
#ifdef CONFIG_GENERIC_ART
    { TEE_SERVICE_ART, 0, MSPC_GROUP_PERMISSION },
#endif
    { TEE_SERVICE_VOICE_REC, 0, MSPC_GROUP_PERMISSION },
#ifdef TEE_HIVCODEC_DYNAMIC_TA
    { TEE_SERVICE_HIVCODEC_SR, 0, VDEC_GROUP_PERMISSION },
#endif
#ifdef DEF_ENG
    { TEE_SERVICE_BUS_TEST, 0, GENERAL_GROUP_PERMISSION },
#endif
#if (defined TEST_INNER_SERVICE_64BIT) || (defined TEST_INNER_SERVICE_32BIT)
    { TEE_INNER_TEST_SERVICE, 0, ALL_GROUP_PERMISSION },
    { TEE_INNER_TEST_TA, 0, ALL_GROUP_PERMISSION },
#endif
};
