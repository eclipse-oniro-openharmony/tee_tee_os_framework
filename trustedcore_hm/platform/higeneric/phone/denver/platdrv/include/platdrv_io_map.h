...
struct ioaddr_t g_ioaddrs[] = {
    ...
    {SOC_ACPU_GPIO9_BASE_ADDR, SOC_ACPU_GPIO9_BASE_ADDR_SIZE},
    ...
    {MEDIA_CRG_BASE_ADDR, MEDIA_CRG_BASE_ADDR_SIZE},                         /* MEDIA_CRG_BASE_ADDR 4k denver */
