 ...
 */
    .protected_regions = {
        { PROTECTED_REGION_START1, PROTECTED_REGION_END1 },
    ...
    .plat_io_regions = {
        ...
        { SOC_ACPU_GPIO33_BASE_ADDR, SOC_ACPU_GPIO33_BASE_ADDR + SOC_ACPU_GPIO33_BASE_ADDR_SIZE },
        { SOC_ACPU_GPIO34_BASE_ADDR, SOC_ACPU_GPIO34_BASE_ADDR + SOC_ACPU_GPIO34_BASE_ADDR_SIZE },
