...
struct platform_info g_plat_cfg = {
    ...
    /* refer to device/hisi/customize/dtsi/arm64/laguna/laguna_memory.dtsi */
    ...
    .plat_io_regions = {
        ...
        { SOC_ACPU_LP_PCTRL_BASE_ADDR, SOC_ACPU_LP_PCTRL_BASE_ADDR + SOC_ACPU_PCTRL_BASE_ADDR_SIZE },
