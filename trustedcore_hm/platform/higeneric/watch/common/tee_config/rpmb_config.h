...
static const struct ta_permission g_rpmb_permission_config[] = {
...
#endif
    { TEE_SERVICE_KEYMASTER,      0, RPMB_GENERIC_PERMISSION },
    ...
    { TEE_SERVICE_GATEKEEPER,     0, RPMB_GENERIC_PERMISSION },
    { TEE_WEAVER_TA,         0, RPMB_GENERIC_PERMISSION },
    { TEE_REMOTE_PIN,             0, RPMB_GENERIC_PERMISSION },
    { TEE_SERVICE_MULTIDRM,       0, RPMB_GENERIC_PERMISSION },
    { TEE_SERVICE_FILE_ENCRY,     0, RPMB_GENERIC_PERMISSION },
};
...
#define REMOTE_PIN_THRESHOLD_SIZE (2U * 1024U)
#define MULTIDRM_THRESHOLD_SIZE   (6U * 1024U)
#define FILE_ENCRY_THRESHOLD_SIZE (8U * 1024U)
...
/* DO NOT EDIT */
    ...
    { TEE_SERVICE_KEYMASTER,   KEYMASTER_THRESHOLD_SIZE },
    ...
    { TEE_SERVICE_GATEKEEPER,  GATEKEEPER_THRESHOLD_SIZE },
    { TEE_WEAVER_TA,      WEAVER_TA_THRESHOLD_SIZE },
    { TEE_REMOTE_PIN,          REMOTE_PIN_THRESHOLD_SIZE },
    { TEE_SERVICE_MULTIDRM,    MULTIDRM_THRESHOLD_SIZE },
    { TEE_SERVICE_FILE_ENCRY,  FILE_ENCRY_THRESHOLD_SIZE},
};
