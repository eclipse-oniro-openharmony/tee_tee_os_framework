...
struct call_info g_kernel_ca_whitelist[] = {
    ...
    { "ufs_key_restore", true, 0, INVALID_PID, TEE_SERVICE_FILE_ENCRY_MTK },
#ifdef TEE_SUPPORT_M_DRIVER
    { "tee_impl", true, 0, INVALID_PID, TEE_SERVICE_TRUSTED_MEM },
    { "cmdq_sec_gp", true, 0, INVALID_PID, TEE_SERVICE_CMDQ_TA },
    { "pseudo_m4u_sec", true, 0, INVALID_PID, TEE_SERVICE_M4U_TA },
#endif
};
...
const struct task_info_st g_product_builtin_task_infos[] = {
    ...
    {TEE_SERVICE_FILE_ENCRY_MTK, FILE_ENCRY_TASK_NAME,      "/file_encry.elf", HM_PRIO_TEE_TA, false},
#endif
#ifdef TEE_SUPPORT_M_DRIVER
    { TEE_SERVICE_TRUSTED_MEM, TRUSTED_MEM_NAME, "/libsecmem.elf", HM_PRIO_TEE_TA, false },
    { TEE_SERVICE_CMDQ_TA, CMDQ_TA_NAME, "/libcmdq.elf", HM_PRIO_TEE_TA, false },
    { TEE_SERVICE_M4U_TA, M4U_TA_NAME, "/libm4u.elf", HM_PRIO_TEE_TA, false },
    { TEE_SERVICE_H264_TA, H264_TA_NAME, "/libh264.elf", HM_PRIO_TEE_TA, false },
#endif
};
...
#endif
    { TEE_SERVICE_PERM, DEFAULT_STACK_SIZE * 8, DEFAULT_HEAP_SIZE * 3, true, false, false, false, NULL, 0 },
...
#ifdef TEE_SUPPORT_FILE_ENCRY_V2
    { TEE_SERVICE_FILE_ENCRY_MTK, DEFAULT_STACK_SIZE * 2, DEFAULT_HEAP_SIZE * 4, true, false, true, false, NULL, 0},
#endif
#endif
#if (defined TEE_SUPPORT_TUI_32BIT || defined TEE_SUPPORT_TUI_64BIT)
    { TEE_SERVICE_TUI, DEFAULT_STACK_SIZE * 8, DEFAULT_HEAP_SIZE * 16, true, false, false, false, NULL, 0 },
#endif
...
#ifdef TEE_SUPPORT_M_DRIVER
    { TEE_SERVICE_TRUSTED_MEM, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, false, false, false, NULL, 0 },
    { TEE_SERVICE_CMDQ_TA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, false, false, false, NULL, 0 },
    { TEE_SERVICE_M4U_TA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, false, false, false, NULL, 0 },
    { TEE_SERVICE_H264_TA, DEFAULT_STACK_SIZE, DEFAULT_HEAP_SIZE, true, false, false, false, NULL, 0 },
#endif
};
...
const struct ta_permission g_ta_permission_config[] = {
    ...
    { TEE_SERVICE_GATEKEEPER, 0, GATEKEEPER_GROUP_PERMISSION },
...
#ifdef TEE_SUPPORT_FILE_ENCRY
#ifdef TEE_SUPPORT_FILE_ENCRY_V2
    { TEE_SERVICE_FILE_ENCRY_MTK, 0, FILE_ENCRY_GROUP_PERMISSION},
#endif
#endif
    { TEE_SERVICE_CHINADRM, 0, VDEC_GROUP_PERMISSION | SECMEM_GROUP_PERMISSION },
    { TEE_SERVICE_FINGERPRINT, 0, FP_GROUP_PERMISSION },
    { TEE_SERVICE_UDFINGERPRINT, 0, FP_GROUP_PERMISSION },
    { TEE_FINGERPRINT_SENSOR_CHECK, 0, FP_GROUP_PERMISSION },
...
#ifdef TEE_SUPPORT_M_DRIVER
    { TEE_SERVICE_TRUSTED_MEM, 0, GENERAL_GROUP_PERMISSION },
    { TEE_SERVICE_CMDQ_TA, 0, GENERAL_GROUP_PERMISSION },
    { TEE_SERVICE_M4U_TA, 0, GENERAL_GROUP_PERMISSION },
    { TEE_SERVICE_H264_TA, 0, GENERAL_GROUP_PERMISSION },
#endif
};
