...
struct platform_info g_plat_cfg = {
...
#else
    /* refer to vendor/mediatek/proprietary/trustzone/atf/v1.6/plat/mediatek/mt6873/include/memory_layout.h */
    ...
    .spi_num_for_notify = MT6853_SPI_NUM,
    ...
    .plat_io_regions = {
        ...
        { IOCFG_BM_BASE_ADDR, IOCFG_BM_BASE_ADDR + IOCFG_BM_BASE_SIAE },
