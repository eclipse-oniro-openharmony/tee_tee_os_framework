...
if ("${CONFIG_SUPPORT_64BIT}" STREQUAL "true")
    list(APPEND PRODUCT_RELEASE_64 kds.elf antiroot.elf)
else()
    list(APPEND PRODUCT_RELEASE_64 kds.elf antiroot.elf)
    list(APPEND PRODUCT_RELEASE_32 kds.elf antiroot.elf)
endif()

if ("${CONFIG_DRV_64BIT}" STREQUAL "false")
    list(APPEND PRODUCT_APPS_32 kds.elf antiroot.elf)
endif()
if ("${CONFIG_DRV_64BIT}" STREQUAL "true")
    list(APPEND PRODUCT_APPS_64 kds.elf antiroot.elf)
endif()
