...
export CONFIG_TUI_MTK_DRIVER := true
...
export CONFIG_M_DRIVER := true
export CONFIG_ARM64_PAN := true
export TEE_SUPPORT_FILE_ENCRY_V2 := true

#set hisi_drv to BLOCKLIST with no -Werror
BLOCKLIST += spi fingerprint touchscreen eSE tui
export BLOCKLIST

arm_chip_apps +=
arm_ext_apps := kds file_encry antiroot
...
# add mtk ta elf in product_apps
endif
