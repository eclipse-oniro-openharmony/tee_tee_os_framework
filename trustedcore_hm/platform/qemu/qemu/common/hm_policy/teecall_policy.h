...
#ifndef QEMU_TEECALL_POLICY_H
#define QEMU_TEECALL_POLICY_H
...
static const cap_teecall_t g_teecall_cap[AC_SID_NUM] = {
    ...
    [AC_ARRAY_IDX(TEE_MISC_DRIVER)]    = { TEECALL_GENERAL_GROUP_PERMISSION | TEECALL_GET_SHAREMEM_GROUP_PERMISSION },
#ifdef DEF_ENG
