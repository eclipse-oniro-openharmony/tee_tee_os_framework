...
static int32_t do_rsa_encrypt(struct crypto_input_data *rsa_encrypt_data, EVP_PKEY_CTX *ctx,
...
static int32_t do_rsa_decrypt(struct crypto_input_data *rsa_decrypt_data, EVP_PKEY_CTX *ctx,
    uint32_t padding, const RSA *rsa_key)
{
