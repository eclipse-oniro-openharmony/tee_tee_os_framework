...
static CCFipsError_t fipsRsaKatEncryptTest(CCRndContext_t *pRndContext,
			                   CCRsaFipsKatContext_t    *pFipsCtx)
{
	...
	rc = CC_RsaOaepEncrypt(pRndContext,
					pUserPubKey,
					pPrimeData,
					FIPS_RSA_HASH_TYPE,
					NULL, 0,
...
static CCFipsError_t fipsRsaKatSignTest(CCRndContext_t *pRndContext,
			              CCRsaFipsKatContext_t    *pFipsCtx)
{
	uint32_t rc = CC_TEE_FIPS_ERROR_OK;
	CCRsaUserPubKey_t 	*pUserPubKey;
...
static CCError_t fipsRsaKatGenVector(CCRndState_t *rndState_ptr,
				...
				CCRsaKgFipsContext_t    *pFipsCtx)
{
	...
	// Encrypt known data
	rc = CC_RsaOaepEncrypt(pRndContext, pCcUserPubKey, pPrimeData,
					FIPS_RSA_HASH_TYPE,
					NULL, 0,
					CC_PKCS1_MGF1,
...
CCFipsError_t CC_FipsRsaKat(CCRndContext_t *pRndContext,
			    CCRsaFipsKatContext_t    *pFipsCtx)
{
        CCError_t rc = CC_OK;
	...
	rc = CC_RndSetGenerateVectorFunc(pRndContext, fipsRsaKatGenVector);
	if (rc != CC_OK) {
