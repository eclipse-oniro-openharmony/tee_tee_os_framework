...
static CCError_t ScalarMultAff(
                         ...
                         uint32_t *bxp, uint32_t *byp, 		/*!< [in] Pointer to coordinates of input EC point. */
...
CCError_t PkaEcWrstScalarMult(const CCEcpkiDomain_t *pDomain,   /*!< [in] Pointer to current EC domain. */
                             ...
                             uint32_t             *inPointX,       /*!< [in] Pointer to the point X coordinate. */
                             uint32_t             *inPointY,       /*!< [in] Pointer to the point Y coordinate. */
