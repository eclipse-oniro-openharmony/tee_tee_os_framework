...
*****************************************************************************/
#define CC_PAL_LOG_CUR_COMPONENT CC_LOG_MASK_CRYS_SYM_DRIVER
...
#else
	for (i = PERF_TEST_TYPE_CRYS_AES_INTGR; i < PERF_TEST_TYPE_MAX; i++) {
#endif
