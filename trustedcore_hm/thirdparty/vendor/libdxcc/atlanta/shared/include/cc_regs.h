...
#if !defined(DX_CC_REE) && !defined(CC_CONFIG_IOT_SUPPORTED) && !defined(CC_SB_SUPPORT_IOT)
#include "dx_nvm.h"
#endif
...
#if defined(DX_CC_REE) || defined(CC_TEE) || defined(CC_CONFIG_IOT_SUPPORTED) || defined(CC_SB_SUPPORT_IOT)
...
#else
#error Execution domain is not DX_CC_REE/CC_TEE/CC_CONFIG_IOT_SUPPORTED
#endif
