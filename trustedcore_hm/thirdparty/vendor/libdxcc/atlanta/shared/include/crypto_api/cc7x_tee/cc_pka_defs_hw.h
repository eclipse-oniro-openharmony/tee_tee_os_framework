...
/*!
@file
@brief This file contains all of the enums and definitions that are used in the PKA related code.
*/


/* The valid key sizes in bits for RSA primitives (exponentiation) */
#define CC_RSA_MAXIMUM_MOD_BUFFER_SIZE_IN_WORDS ((CC_RSA_MAX_VALID_KEY_SIZE_VALUE_IN_BITS + 64) / CC_BITS_IN_32BIT_WORD )
