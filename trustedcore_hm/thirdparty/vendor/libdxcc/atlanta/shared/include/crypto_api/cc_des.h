...
/************************ Defines ******************************/
/*! The size of user's context prototype (see CCDesUserContext_t) in words. */
...
typedef enum
{
   ...
   CC_DES_NumOfKeysOptions,

   CC_DES_NumOfKeysLast= 0x7FFFFFFF,
...
typedef enum
{
    ...
    CC_DES_EncryptNumOfOptions,

    CC_DES_EncryptModeLast = 0x7FFFFFFF,
...
typedef enum
{
    ...
    CC_DES_OperationModeLast = 0x7FFFFFFF,
...
{
   /* the key variables */
   uint8_t key1[CC_DES_KEY_SIZE_IN_BYTES];
   uint8_t key2[CC_DES_KEY_SIZE_IN_BYTES];
   uint8_t key3[CC_DES_KEY_SIZE_IN_BYTES];
...
{
   /* the key variables */
   uint32_t key1[CC_DES_KEY_SIZE_IN_WORDS];
   uint32_t key2[CC_DES_KEY_SIZE_IN_WORDS];
   uint32_t key3[CC_DES_KEY_SIZE_IN_WORDS];
...
/*! The user's context prototype - the argument type that is passed by the user
   to the APIs called. */
typedef struct CCDesUserContext_t
{
