                                            ...
                                            CRYS_ECPKI_KG_TempData_t *TempData_ptr /* in */)
{
    ...
    RETURN_IF_ECPKI_UNSUPPORTED(DomainID, UserPrivKey_ptr, UserPublKey_ptr, TempData_ptr, Error, Error, Error, Error,
    ...
    if (DxCcAcl_IsBuffAccessOk(ACCESS_READ_WRITE, UserPrivKey_ptr, sizeof(CRYS_ECPKI_UserPrivKey_t)) ||
        ...
        ((TempData_ptr != DX_NULL) &&
         DxCcAcl_IsBuffAccessOk(ACCESS_READ_WRITE, TempData_ptr, sizeof(CRYS_ECPKI_KG_TempData_t)))) {
    ...
    Error = LLF_ECPKI_GenKeyPairCall(DomainID, 1 /* isKeyInternal */, UserPrivKey_ptr, UserPublKey_ptr, TempData_ptr);
...
End:
    ...
    /*     clear the KG data structures    */
    DX_PAL_MemSet(TempData_ptr, 0, sizeof(CRYS_ECPKI_KG_TempData_t));
    if (Error != CRYS_OK) {
        DX_PAL_MemSet(UserPublKey_ptr, 0, sizeof(CRYS_ECPKI_UserPublKey_t));
        DX_PAL_MemSet(UserPrivKey_ptr, 0, sizeof(CRYS_ECPKI_UserPrivKey_t));
    }
