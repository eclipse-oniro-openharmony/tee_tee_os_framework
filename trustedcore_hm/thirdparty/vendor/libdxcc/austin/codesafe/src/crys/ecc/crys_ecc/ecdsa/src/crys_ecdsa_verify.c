...
#error CRYS_PKA_RSA_HASH_CTX_SIZE_IN_WORDS or CRYS_HASH_USER_CTX_SIZE_IN_WORDS  defined not correctly.
#endif
                                            ...
                                            CRYS_ECPKI_HASH_OpMode_t HashMode /* in */)
{
    ...
    RETURN_IF_ECPKI_UNSUPPORTED(VerifyUserContext_ptr, SignerPublKey_ptr, HashMode, ccmWorkingContext_ptr, PublKey_ptr,
                                DomainID, Error1, Error, Error, Error, Error, Error, Error, Error, Error, Error, Error,
    ...
    DX_PAL_MemSet(ccmWorkingContext_ptr, 0, sizeof(ECDSA_VerifyContext_t));
    ...
    DX_PAL_MemCopy((uint8_t *)&ccmWorkingContext_ptr->ECDSA_SignerPublKey, (uint8_t *)SignerPublKey_ptr,
...
END_WITH_ERROR:
    /* ................. release the context ................................. */
    /* ----------------------------------------------------------------------- */
    Error1 = CRYS_CCM_ReleaseContext(VerifyUserContext_ptr,    /* the users context space - in */
                                     ccmWorkingContext_ptr,    /* the CCM context returned - in */
                                     DX_ECDSA_VERIFY_CONTEXT); /* ECDSA type - in */
    if (Error1)
        Error = Error1;
    ...
    /* -------------------------------------------------------------------- */
    DX_PAL_MemSet(VerifyUserContext_ptr, 0, sizeof(CRYS_ECDSA_VerifyUserContext_t));
                                              ...
                                              uint32_t DataInSize /* in */)
{
    ...
    RETURN_IF_ECPKI_UNSUPPORTED(VerifyUserContext_ptr, MessageDataIn_ptr, DataInSize, ccmWorkingContext_ptr, Error1,
                                              ...
                                              uint32_t SignatureSizeBytes /* in */)
{
    ...
    RETURN_IF_ECPKI_UNSUPPORTED(VerifyUserContext_ptr, SignatureIn_ptr, SignatureSizeBytes, Error,
                                ccmWorkingContext_ptr, PublKey_ptr, DomainID, DomainInfo.EC_ModulusSizeInBits,
                                MessageRepresent_ptr, HashSizeWords, SignatureC_ptr, SignatureD_ptr, TempBuff_ptr,
                                Error1, OrderSizeInBytes, OrderSizeInWords, Shift, i, Error, Error, Error, Error);
    ...
    /* Clean memory  */
    DX_PAL_MemSetZero(SignatureC_ptr, 2 * 4 * OrderSizeInWords);
     ...
     *  words                                  */
    {
        Error = CRYS_COMMON_ConvertMsbLsbBytesToLswMswWords(SignatureC_ptr, 4 * OrderSizeInWords, SignatureIn_ptr,
                                                            OrderSizeInBytes);
        if (Error != CRYS_OK)
            return Error;

        Error = CRYS_COMMON_ConvertMsbLsbBytesToLswMswWords(SignatureD_ptr, 4 * OrderSizeInWords,
    ...
    Error = LLF_ECDSA_VerifyCalcCall(PublKey_ptr, MessageRepresent_ptr, SignatureC_ptr, SignatureD_ptr, TempBuff_ptr);
    if (Error != CRYS_OK)
        goto END_WITH_ERROR;
...
END_WITH_ERROR:
    ...
    /* .............. clearing the users context in case of error.......... */
    /* -------------------------------------------------------------------- */
    DX_PAL_MemSetZero(VerifyUserContext_ptr, sizeof(CRYS_ECDSA_VerifyUserContext_t));
                                        ...
                                        uint32_t MessageSizeInBytes /* in */)
{
    ...
    RETURN_IF_ECPKI_UNSUPPORTED(VerifyUserContext_ptr, UserPublKey_ptr, HashMode, MessageDataIn_ptr, MessageSizeInBytes,
                                SignatureIn_ptr, SignatureSizeBytes, Error, Error, Error, Error, Error, Error, Error,
    ...
    Error = CRYS_ECDSA_VerifyUpdate(VerifyUserContext_ptr, MessageDataIn_ptr, MessageSizeInBytes);
    if (Error != CRYS_OK)
    ...
    Error = CRYS_ECDSA_VerifyFinish(VerifyUserContext_ptr, SignatureIn_ptr, SignatureSizeBytes);
    return Error;
