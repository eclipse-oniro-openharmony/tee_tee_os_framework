...
#define LLF_ECPKI_InitPubKeyDb(PubKey_ptr) _DX_LLF_ECPKI_InitPubPrivKeyDb((PubKey_ptr), DX_NULL)

/* initialize private key database */
#define LLF_ECPKI_InitPrivKeyDb(PrivKey_ptr) _DX_LLF_ECPKI_InitPubPrivKeyDb(DX_NULL, (PrivKey_ptr))
...
/*
   ...
   @return CRYSError_t - CRYS_OK,
                         Error from called functions
*/
CRYSError_t LLF_ECPKI_ELGAMAL_Encrypt(CRYS_ECPKI_PublKey_t *receiverPublKey_ptr, /* in */
                                      uint32_t *EncrMessageOut_ptr,              /* out */
...
/*
  ...
  Assumptions: Public key W and EC domain parameters q, a, b, r, and G are
   ...
   @return CRYSError_t - CRYS_OK,
                         Error from called functions
*/
CRYSError_t LLF_ECPKI_ELGAMAL_Decrypt(CRYS_ECPKI_PrivKey_t *ReceiverPrivKey_ptr, /* in */
                                      uint32_t *EncrMessage_ptr,                 /* in */
                                      uint32_t *DecrMessageOut_ptr,              /* out */
                                      uint32_t MessageOutSizeBytes,              /* in */
