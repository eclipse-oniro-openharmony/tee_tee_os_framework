...
/*
       ...
       following domain structure:
        ...
        typedef  const  struct {
            ...
            uint32_t        EC_GenerOrder [CRYS_ECPKI_MODUL_MAX_LENGTH_IN_WORDS];
...
const CRYS_ECPKI_Domain_t LLF_EC_DOMAINS_ARRAY[] = {
    ...
    /* *****  EC Domain: CRYS_ECPKI_DomainID_secp160k1 = 0  ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000010, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x240A8CA6, 0xFFC8E0BD, 0xFFFFFFFF, 0xFFFFFFFF,
          0x0000001F },
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp160r1 = 1  ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000008, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0xDB0A2586, 0xFFC166E0, 0xFFFFFFFF, 0xFFFFFFFF,
          0x0000001F },
...

    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000010, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x0F2AFCE1, 0xFFF95C23, 0xFFFFFFFF, 0xFFFFFFFF,
          0x0000001F },
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp192k1 = 3   ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x90D03E8F, 0x0000001D, 0x00000000, 0x00000000,
          0x00000010 },
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp192r1 = 4  ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000010, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x62107C9E, 0x00000006, 0x00000000, 0x00000000,
          0x00000010 },
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp224k1 = 5   ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0xFFC462E5, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
          0x0000001F },
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp224r1 = 6 ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x0000000F, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x000E95D1 /* 0x00095D1F */, 0x00000000, 0x00000000,
    ...
    /* ***** EC Domain: CRYS_ECPKI_DomainID_secp256k1 = 7 ** */
    {
        ...
        /* Barrett tags NP,RP */
        { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x00000014, 0x00000000, 0x00000000, 0x00000000,
          0x00000010 },
...

    {
        ...
        /* Barrett tags NP,RP */
        { 0xFFFFFFEF, 0xFFFFFFEF, 0xFFFFFFFF, 0x0000000F, 0x00000010, 0xFFFFFFF4, 0xFFFFFFEF, 0xFFFFFFFF, 0x0000000F,
          0x00000010 },
    ...
    {
        /* Field modulus :  GF_Modulus =
           FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF - big end */
        { 0xFFFFFFFF, 0x00000000, 0x00000000, 0xFFFFFFFF, 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
          0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF },
        /* EC equation parameters a, b  */
        /* a = FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC   - big
           end  from SEC2 */
        { 0xFFFFFFFC, 0x00000000, 0x00000000, 0xFFFFFFFF, 0xFFFFFFFE, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
          0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF },
        /* b = B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF  - big
           end  from SEC2 */
        { 0xD3EC2AEF, 0x2A85C8ED, 0x8A2ED19D, 0xC656398D, 0x5013875A, 0x0314088F, 0xFE814112, 0x181D9C6E, 0xE3F82D19,
          0x988E056B, 0xE23EE7E4, 0xB3312FA7 },

        /* Order of generator:
           FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973  big end
           from SEC2 */
        { 0xCCC52973, 0xECEC196A, 0x48B0A77A, 0x581A0DB2, 0xF4372DDF, 0xC7634D81, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
          0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF },

        /* Generator  coordinates in affine form: EC_Gener_X, EC_Gener_Y (in ordinary representation) */
        /* AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7    X - big
           end  from SEC2 */
        { 0x72760AB7, 0x3A545E38, 0xBF55296C, 0x5502F25D, 0x82542A38, 0x59F741E0, 0x8BA79B98, 0x6E1D3B62, 0xF320AD74,
          0x8EB1C71E, 0xBE8B0537, 0xAA87CA22 },
        /* 3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F   Y - big
           end  from SEC2 */
        { 0x90EA0E5F, 0x7A431D7C, 0x1D7E819D, 0x0A60B1CE, 0xB5F0B8C0, 0xE9DA3113, 0x289A147C, 0xF8F41DBD, 0x9292DC29,
        ...
        /* Barrett tags NP,RP */
        { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
          0x00000010 },
...

    {
        ...
        /* a =
           ...
           - big end  from SEC2 */
        { 0xFFFFFFFC, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
          0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x000001FF },
        /* b = Bec=
           51953EB9618E1C9A1F929A21A0B68540EEA2DA725B99B315F3B8B489918EF109E156193951EC7E937B1652C0BD3BB1BF073573DF883D2C34F1EF451FD46B503F00
         */
        { 0x6B503F00, 0xEF451FD4, 0x3D2C34F1, 0x3573DF88, 0x3BB1BF07, 0x1652C0BD, 0xEC7E937B, 0x56193951, 0x8EF109E1,
          0xB8B48991, 0x99B315F3, 0xA2DA725B, 0xB68540EE, 0x929A21A0, 0x8E1C9A1F, 0x953EB961, 0x00000051 },

        /* Order of generator:
           1FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA51868783BF2F966B7FCC0148F709A5D03BB5C9B8899C47AEBB6FB71E91386409
           big end  from SEC2 */
        { 0x91386409, 0xBB6FB71E, 0x899C47AE, 0x3BB5C9B8, 0xF709A5D0, 0x7FCC0148, 0xBF2F966B, 0x51868783, 0xFFFFFFFA,
          0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x000001FF },
        ...
        /* Barrett tags NP,RP */
        { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010, 0x00000008, 0x00000000, 0x00000000, 0x00000000,
          0x00000010 },
