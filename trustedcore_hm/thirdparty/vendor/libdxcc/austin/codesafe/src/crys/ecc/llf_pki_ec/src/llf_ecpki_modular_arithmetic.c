...
CRYSError_t LLF_ECPKI_LucasSequence(int8_t rP,            /* in */
                                    int8_t rQ,            /* in */
                                    int8_t rk,            /* in */
                                    int8_t rv0,           /* out */
                                    int8_t rq0,           /* out */
...
CRYSError_t LLF_ECPKI_SquareRootModPrime(int8_t rg,              /* in */
                                         int8_t rz,              /* out */
                                         ...
                                         uint32_t VirtualHwBaseAddr /* in */)
{
    ...
    /* virtual pointers  */
    int8_t rk, rQ0, rV, rT, rP, ry;

    /* last word of modulus */
    uint32_t modLSW;

    int32_t status1, status2; /* Variables for logic results */
    ...
    *isRootExists = DX_FALSE;
    ...
    /* ---------------------------------------------------------------------- */
        ...
        while (1) {
            ...
            LLF_ECPKI_LucasSequence(rP, rg, rk, rV, rQ0, regTemps_ptr + 5, countTemps - 5, VirtualHwBaseAddr);
