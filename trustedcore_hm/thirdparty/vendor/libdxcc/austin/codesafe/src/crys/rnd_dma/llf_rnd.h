...
typedef struct {
    ...
    /* special buffers */
    uint32_t h[CRYS_RND_NB];      /* histogram */
    uint32_t ec[CRYS_RND_NB / 2]; /* equality counter for prefix */
 ...
 */
CRYSError_t LLF_RND_GetEntropySourceSize(CRYS_RND_Params_t *trngParams,   /* in */
 ...
 */
CRYSError_t LLF_RND_GetRngParams(uint32_t *KeySizeWords, uint32_t *TrngMode, uint32_t *RoscsAllowed,
 ...
 */
CRYSError_t LLF_RND_SetUserRngParameters(CRYS_RND_State_t *rndState_ptr, CRYS_RND_Params_t *trngParams_ptr);
