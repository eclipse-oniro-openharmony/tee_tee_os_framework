...
typedef struct CRYS_OAEP_Data_t {
    uint8_t MaskDB[CRYS_RSA_OAEP_ENCODE_MAX_MASKDB_SIZE];
    uint8_t SeedMask[CRYS_RSA_OAEP_ENCODE_MAX_SEEDMASK_SIZE];
    CRYS_HASHUserContext_t HashUsercontext;
    CRYS_HASH_Result_t HashResultBuff;
} DX_PAL_COMPILER_TYPE_MAY_ALIAS CRYS_OAEP_Data_t;
