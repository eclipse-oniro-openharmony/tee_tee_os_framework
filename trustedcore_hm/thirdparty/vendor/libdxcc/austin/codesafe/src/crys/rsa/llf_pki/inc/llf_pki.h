...
/* define only for debugging of HW ModInv function */
// RL Debug
// #define HW_MOD_INV_CALC_FAILS_COUNT  1
...
typedef uint32_t LLF_PKI_PKA_RegsSizes_t[LLF_PKI_PKA_MAX_COUNT_OF_REGS_SIZES];

/* type definition of the list of temp registers, containing numbers, which
   may be used as temp registes registers  */
typedef uint8_t LLF_PKI_PKATempRegs_t[LLF_PKI_PKA_MAX_COUNT_OF_REGS_SIZES];

/* Barrett modulus tag type - 5 words size array */
typedef uint32_t LLF_PKI_PKA_NP_t[LLF_PKI_PKA_BARRETT_MOD_TAG_BUFF_SIZE_IN_WORDS];
...
typedef struct {
    uint32_t RegsNum[LLF_PKI_PKA_MAX_COUNT_OF_PHYS_MEM_REGS];
    uint32_t RegsAddr[LLF_PKI_PKA_MAX_COUNT_OF_PHYS_MEM_REGS];
...
#define LLF_PKI_PKA_ModInvHw(LenID, OpB, Res, Tag, VirtualHwBaseAddr) \
 ...
 */
CRYSError_t LLF_PKI_ExecPrivKeyExpNonCrt(CRYSRSAPrivKey_t *PrivKey_ptr, CRYS_RSAPrimeData_t *PrivData_ptr,
                                         uint32_t VirtualHwBaseAddr);
 ...
 *                        value MODULE_* as defined in .
 */
CRYSError_t LLF_PKI_ExecPrivKeyExpCrt(CRYSRSAPrivKey_t *PrivKey_ptr, CRYS_RSAPrimeData_t *PrivData_ptr,
                                      uint32_t VirtualHwBaseAddr);
...
CRYSError_t LLF_PKI_genKeyNonCrt(uint32_t *e_ptr, uint32_t eSizeInBits, uint32_t nSizeInBits, uint32_t testsCount,
                                 uint32_t *Success_ptr, uint32_t *p_ptr, uint32_t *q_ptr, uint32_t *n_ptr,
                                 uint32_t *d_ptr, uint32_t *temp_ptr, uint32_t VirtualHwBaseAddr);
 ...
 *                        value MODULE_* as defined in ...
 */
CRYSError_t LLF_PKI_genKeyCrt(uint32_t *e_ptr,       /* in */
                              uint32_t eSizeInBits,  /* in */
                              uint32_t nSizeInBits,  /* in */
                              uint32_t testsCount,   /* in */
...
CRYSError_t LLF_PKI_CalculateNandD(uint32_t *e_ptr, uint32_t eSizeInBits, uint32_t *p_ptr, uint32_t *q_ptr,
 ...
 *                        value MODULE_* as defined in ...
 */
CRYSError_t LLF_PKI_CalculateCrtParams(uint32_t *e_ptr, uint32_t eSizeInBits, uint32_t nSizeInBits, uint32_t *p_ptr,
                                       uint32_t *q_ptr, uint32_t *dp_ptr, uint32_t *dq_ptr, uint32_t *qInv_ptr,
                                       uint32_t VirtualHwBaseAddr);
...
CRYSError_t LLF_PKI_primeTest(uint32_t *P_ptr, int32_t sizeWords, int32_t rabinTestsCount, int8_t *isPrime_ptr,
                              CRYS_RSA_DH_PrimeTestMode_t primeTestMode, uint32_t *temp_ptr,
                              uint32_t VirtualHwBaseAddr);
 ...
 *                 sizes table.
 *               - Meets condition: (firstReg + countOfRegs) <= 32.
 ...
 *
 */
void LLF_PKI_PKA_ModDivideBy2(uint8_t LenID, int8_t rX, int8_t rN, int8_t rRes, uint8_t Tag,
                              uint32_t VirtualHwBaseAddr);
