...
#define GET_HW_Q_DESC_WORD_IDX(qid, descWordIdx) \
    (DX_CC_REG_OFFSET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD##descWordIdx) + (32 * (qid)))
...
#define HW_DESC_PUSH_TO_QUEUE(qid, pDesc)                                         \
    do {                                                                          \
        LOG_HW_DESC(pDesc);                                                       \
        HW_DESC_DUMP(pDesc);                                                      \
...
#define HW_DESC_SET_DIN_TYPE(pDesc, dmaMode, dinAdr, dinSize, axiId, axiNs)                               \
    do {                                                                                                  \
        ...
        DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD5, DIN_ADDR_HIGH, (pDesc)->word[5],              \
...
#define HW_DESC_SET_DOUT_TYPE(pDesc, dmaMode, doutAdr, doutSize, axiId, axiNs)                             \
    do {                                                                                                   \
        ...
        DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD5, DOUT_ADDR_HIGH, (pDesc)->word[5],              \
