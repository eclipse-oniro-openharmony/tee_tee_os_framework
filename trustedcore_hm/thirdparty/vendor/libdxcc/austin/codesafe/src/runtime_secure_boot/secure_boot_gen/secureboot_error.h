...
#define DX_BOOT_IMG_VERIFIER_BASE_ERROR \
    DX_SECUREBOOT_BASE_ERROR + DX_SB_VERIFIER_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
/* NVM Base error = 0xF4000000 */
#define DX_NVM_BASE_ERROR DX_SECUREBOOT_BASE_ERROR + DX_SB_NVM_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
/* SEP Base error = 0xF5000000 */
#define DX_SB_SEP_BASE_ERROR DX_SECUREBOOT_BASE_ERROR + DX_SB_SEP_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
/* HAL Base error = 0xF6000000 */
#define DX_SB_HAL_BASE_ERROR DX_SECUREBOOT_BASE_ERROR + DX_SB_HAL_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
/* RSA Base error = 0xF7000000 */
#define DX_SB_RSA_BASE_ERROR DX_SECUREBOOT_BASE_ERROR + DX_SB_RSA_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
/* Boot Images verifier cert Base error = 0xF8000000 */
#define DX_BOOT_IMG_VERIFIER_CERT_BASE_ERROR \
    DX_SECUREBOOT_BASE_ERROR +               \
        DX_SB_VERIFIER_CERT_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR /* x509 Base error = 0xF9000000 */
#define DX_SB_X509_CERT_BASE_ERROR \
    DX_SECUREBOOT_BASE_ERROR + DX_SB_X509_CERT_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR

/* crypto driver error base = 0xF2000000 */
#define DX_SB_DRV_BASE_ERROR DX_SECUREBOOT_BASE_ERROR + DX_SB_DRV_LAYER_PREFIX *DX_SECUREBOOT_LAYER_BASE_ERROR
...
#define DX_SB_DRV_MEMORY_ERROR_ERR  DX_SB_DRV_BASE_ERROR + 0x00000002
