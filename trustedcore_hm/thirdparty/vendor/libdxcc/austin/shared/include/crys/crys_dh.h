 ...
 * @brief _DX_DH_GeneratePubPrv has 2 functionalities:
  ...
  @return CRYSError_t - On success CRYS_OK is returned, on failure an ERROR as defined CRYS_DH_error.h:
            ...
            CRYS_DH_INVALID_ARGUMENT_OPERATION_MODE_ERROR;
 */
CIMPORT_C CRYSError_t _DX_DH_GeneratePubPrv(uint8_t *Generator_ptr,                     /* generator */
                                            uint16_t GeneratorSize, uint8_t *Prime_ptr, /* modulus */
                                            uint16_t PrimeSize, uint16_t L, /* Exact length of Private key in bits */
                                            uint8_t *Q_ptr,                 /* order */
                                            uint16_t QSize, CRYS_DH_OpMode_t DH_mode,
...
/* -------------------------------------------------------------------------------- */
#define CRYS_DH_PKCS3_GeneratePubPrv(Generator_ptr, GeneratorSize, Prime_ptr, PrimeSize, L, tmpPubKey_ptr,          \
                                     tmpPrimeData_ptr, ClientPrvKey_ptr, ClientPrvKeySize_ptr, ClientPub_ptr,       \
                                     ClientPubSize_ptr)                                                             \
    _DX_DH_GeneratePubPrv((Generator_ptr), (GeneratorSize), (Prime_ptr), (PrimeSize), (L), (uint8_t *)DX_NULL,      \
                          (uint16_t)0, CRYS_DH_PKCS3_mode, (tmpPubKey_ptr), (tmpPrimeData_ptr), (ClientPrvKey_ptr), \
...
#define CRYS_DH_ANSI_X942_GeneratePubPrv(Generator_ptr, GeneratorSize, Prime_ptr, PrimeSize, Q_ptr, QSize,           \
                                         tmpPubKey_ptr, tmpPrimeData_ptr, ClientPrvKey_ptr, ClientPrvKeySize_ptr,    \
                                         ClientPub_ptr, ClientPubSize_ptr)                                           \
    _DX_DH_GeneratePubPrv((Generator_ptr), (GeneratorSize), (Prime_ptr), (PrimeSize), (uint16_t)0, (Q_ptr), (QSize), \
                          CRYS_DH_ANSI_X942_mode, (tmpPubKey_ptr), (tmpPrimeData_ptr), (ClientPrvKey_ptr),           \
                          (ClientPrvKeySize_ptr), (ClientPub_ptr), (ClientPubSize_ptr))
...
*/
CIMPORT_C CRYSError_t CRYS_DH_GetSecretKey(uint8_t *ClientPrvKey_ptr, uint16_t ClientPrvKeySize,
...
*/
CIMPORT_C CRYSError_t CRYS_DH_X942_GetSecretData(uint8_t *ClientPrvKey_ptr, uint16_t ClientPrvKeySize,
...
*/
#define CRYS_DH_X942_GetSecretDataAsn1(ClientPrvKey_ptr, ClientPrvKeySize, ServerPubKey_ptr, ServerPubKeySize, \
                                       Prime_ptr, PrimeSize, otherInfo_ptr, hashMode, tmpBuff_ptr,             \
                                       SecretKeyingData_ptr, SecretKeyingDataSize)                             \
    CRYS_DH_X942_GetSecretData((ClientPrvKey_ptr), (ClientPrvKeySize), (ServerPubKey_ptr), (ServerPubKeySize), \
                               (Prime_ptr), (PrimeSize), (otherInfo_ptr), (hashMode), (CRYS_DH_ASN1_Der_mode), \
...
#define CRYS_DH_X942_GetSecretDataConcat(ClientPrvKey_ptr, ClientPrvKeySize, ServerPubKey_ptr, ServerPubKeySize, \
                                         ...
                                         SecretKeyingData_ptr, SecretKeyingDataSize)                             \
    CRYS_DH_X942_GetSecretData((ClientPrvKey_ptr), (ClientPrvKeySize), (ServerPubKey_ptr), (ServerPubKeySize),   \
                               (Prime_ptr), (PrimeSize), (otherInfo_ptr), (hashMode), (CRYS_DH_Concat_Der_mode), \
                               (tmpBuff_ptr), (SecretKeyingData_ptr), (SecretKeyingDataSize))
...
#define CRYS_DH_X942_HybridGetSecretDataAsn1(                                                                         \
    ...
    CRYS_DH_X942_HybridGetSecretData(                                                                                 \
        ...
        (hashFunc), CRYS_DH_ASN1_Der_mode, (tmpDhHybr_ptr), (SecretKeyingData_ptr), (SecretKeyingDataSize))
...
#define CRYS_DH_X942_HybridGetSecretDataConcat(                                                                       \
    ...
    CRYS_DH_X942_HybridGetSecretData(                                                                                 \
        (ClientPrvKey_ptr1), (ClientPrvKeySize1), (ClientPrvKey_ptr2), (ClientPrvKeySize2), (ServerPubKey_ptr1),      \
        (ServerPubKeySize1), (ServerPubKey_ptr2), (ServerPubKeySize2), (Prime_ptr), (PrimeSize), (otherInfo_ptr),     \
        (hashFunc), CRYS_DH_Concat_Der_mode, (tmpDhHybr_ptr), (SecretKeyingData_ptr), (SecretKeyingDataSize))
 ...
 */
CIMPORT_C CRYSError_t CRYS_DH_CheckPubKey(uint8_t *modP_ptr,        /* in */
