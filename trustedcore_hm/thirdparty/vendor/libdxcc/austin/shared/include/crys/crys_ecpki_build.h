...
*/
CIMPORT_C CRYSError_t CRYS_ECPKI_BuildPrivKey(CRYS_ECPKI_DomainID_t DomainID, /* in */
...
*/
CIMPORT_C CRYSError_t _DX_ECPKI_BuildPublKey(CRYS_ECPKI_DomainID_t DomainID,            /* in */
...
#define CRYS_ECPKI_BuildPublKey(DomainID, PublKeyIn_ptr, PublKeySizeInBytes, UserPublKey_ptr)            \
    _DX_ECPKI_BuildPublKey((DomainID), (PublKeyIn_ptr), (PublKeySizeInBytes), CheckPointersAndSizesOnly, \
                           (UserPublKey_ptr), DX_NULL)
...
#define CRYS_ECPKI_BuildPublKeyPartlyCheck(DomainID, PublKeyIn_ptr, PublKeySizeInBytes, UserPublKey_ptr, TempBuff_ptr) \
    _DX_ECPKI_BuildPublKey(DomainID, PublKeyIn_ptr, PublKeySizeInBytes, ECpublKeyPartlyCheck, UserPublKey_ptr,         \
                           TempBuff_ptr)
...
#define CRYS_ECPKI_BuildPublKeyFullCheck(DomainID, PublKeyIn_ptr, PublKeySizeInBytes, UserPublKey_ptr, TempBuff_ptr) \
    _DX_ECPKI_BuildPublKey(DomainID, PublKeyIn_ptr, PublKeySizeInBytes, ECpublKeyFullCheck, UserPublKey_ptr,         \
                           TempBuff_ptr)
...
*/
CIMPORT_C CRYSError_t CRYS_ECPKI_ExportPublKey(CRYS_ECPKI_UserPublKey_t *UserPublKey_ptr, /* in */
...
/* !\brief     The function performs export (converting to big endian) the user private
   ...
   @return   CRYSError_t: on success - CRYS_OK, on failure - error code:
             ...
             CRYS_ECPKI_BUILD_KEY_INVALID_USER_PRIV_KEY_PTR_ERROR
*/
CIMPORT_C CRYSError_t CRYS_ECPKI_ExportPrivKey(CRYS_ECPKI_UserPrivKey_t *UserPrivKey_ptr, /* in */
