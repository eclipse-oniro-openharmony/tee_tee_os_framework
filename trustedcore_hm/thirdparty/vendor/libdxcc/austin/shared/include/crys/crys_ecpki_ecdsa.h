...
*/
CIMPORT_C CRYSError_t CRYS_ECDSA_SignInit(CRYS_ECDSA_SignUserContext_t *SignUserContext_ptr, /* in/out */
...
*/
CIMPORT_C CRYSError_t _DX_ECDSA_SignFinish(CRYS_ECDSA_SignUserContext_t *SignUserContext_ptr, /* in */
...
/*
   ...
   @return <b>CRYSError_t</b>: <br>
             ...
             CRYS_ECDSA_SIGN_INVALID_DOMAIN_ID_ERROR <br>
*/
CIMPORT_C CRYSError_t CRYS_ECDSA_Sign(CRYS_ECDSA_SignUserContext_t *SignUserContext_ptr, /* in/out */
                                      CRYS_ECPKI_UserPrivKey_t *SignerPrivKey_ptr,       /* in */
                                      CRYS_ECPKI_HASH_OpMode_t HashMode,                 /* in */
                                      uint8_t *MessageDataIn_ptr,                        /* in */
...
*/
CIMPORT_C CRYSError_t CRYS_ECDSA_VerifyFinish(CRYS_ECDSA_VerifyUserContext_t *VerifyUserContext_ptr, /* in */
