...
*/
CIMPORT_C CRYSError_t _DX_ECPKI_ELGAMAL_Encrypt(CRYS_ECPKI_UserPublKey_t *ReceiverUserPublKey_ptr, /* in */
...
*/
#define CRYS_ECPKI_ELGAMAL_Encrypt(ReceiverUserPublKey_ptr, MessageIn_ptr, MessageInSizeBytes, EncrMessageOut_ptr, \
                                   EncrMessageOutSize_ptr, TempData_ptr)                                           \
    _DX_ECPKI_ELGAMAL_Encrypt(ReceiverUserPublKey_ptr, MessageIn_ptr, MessageInSizeBytes, EncrMessageOut_ptr,      \
                              EncrMessageOutSize_ptr, DX_TRUE, DX_NULL, 0, TempData_ptr)
...
*/
CIMPORT_C CRYSError_t CRYS_ECPKI_ELGAMAL_Decrypt(CRYS_ECPKI_UserPrivKey_t *ReceiverUserPrivKey_ptr, /* in */
