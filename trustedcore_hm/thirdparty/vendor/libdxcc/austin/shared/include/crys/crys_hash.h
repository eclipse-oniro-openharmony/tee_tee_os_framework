...
CIMPORT_C CRYSError_t CRYS_HASH_Update(CRYS_HASHUserContext_t *ContextID_ptr, uint8_t *DataIn_ptr, uint32_t DataInSize);
...
CIMPORT_C CRYSError_t CRYS_HASH(CRYS_HASH_OperationMode_t OperationMode, uint8_t *DataIn_ptr, uint32_t DataSize,
