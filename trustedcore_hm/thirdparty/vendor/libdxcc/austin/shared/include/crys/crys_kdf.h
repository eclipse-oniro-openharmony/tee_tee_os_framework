...
*/
CIMPORT_C CRYSError_t CRYS_KDF_KeyDerivFunc(uint8_t *ZZSecret_ptr, uint32_t ZZSecretSize,
...
*/
#define CRYS_KDF_ASN1_KeyDerivFunc(ZZSecret_ptr, ZZSecretSize, OtherInfo_ptr, KDFhashMode, KeyingData_ptr,         \
                                   KeyLenInBytes)                                                                  \
    CRYS_KDF_KeyDerivFunc((ZZSecret_ptr), (ZZSecretSize), (OtherInfo_ptr), (KDFhashMode), CRYS_KDF_ASN1_DerivMode, \
 ...
 * @brief CRYS_KDF_ConcatKeyDerivFunc performs key derivation according to concatenation mode defined
          ...
          function definitions).
*/
#define CRYS_KDF_ConcatKeyDerivFunc(ZZSecret_ptr, ZZSecretSize, OtherInfo_ptr, KDFhashMode, KeyingData_ptr,         \
                                    KeyLenInBytes)                                                                  \
    CRYS_KDF_KeyDerivFunc((ZZSecret_ptr), (ZZSecretSize), (OtherInfo_ptr), (KDFhashMode), CRYS_KDF_ConcatDerivMode, \
                          (KeyingData_ptr), (KeyLenInBytes))
...
#define CRYS_KDF_OMADRM_KeyDerivFunc(ZZSecret_ptr, ZZSecretSize, KeyingData_ptr, KeyLenInBytes)                       \
    CRYS_KDF_KeyDerivFunc((ZZSecret_ptr), (ZZSecretSize), DX_NULL, CRYS_KDF_HASH_SHA1_mode, CRYS_KDF_ConcatDerivMode, \
                          (KeyingData_ptr), (KeyLenInBytes))
