 ...
 *                        value MODULE_* as defined in ...
 */
CIMPORT_C CRYSError_t CRYS_RND_GenerateVector(uint16_t outSizeBytes, /* in */
                                              uint8_t *out_ptr);     /* out */
 ...
 */
CIMPORT_C CRYSError_t CRYS_RND_GenerateVectorInRange(uint32_t rndSizeInBits, uint8_t *maxVect_ptr,
                                                     uint8_t *rndVect_ptr);
 ...
 *                        value MODULE_* as defined in ...
 */
CIMPORT_C CRYSError_t CRYS_RND_AddAdditionalInput(uint8_t *AdditonalInput_ptr, uint16_t AdditonalInputSize);
 ...
 *                        value MODULE_* as defined in ...
 */
CIMPORT_C CRYSError_t CRYS_RND_EnterKatMode(uint8_t *entrData_ptr, uint32_t entrSize, uint8_t *nonce_ptr,
