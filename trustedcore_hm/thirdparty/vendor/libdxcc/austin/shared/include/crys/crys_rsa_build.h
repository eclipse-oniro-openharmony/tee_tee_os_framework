 ...
 */
CIMPORT_C CRYSError_t CRYS_RSA_Build_PubKey(CRYS_RSAUserPubKey_t *UserPubKey_ptr, uint8_t *Exponent_ptr,
 ...
 *
 */
CIMPORT_C CRYSError_t CRYS_RSA_Build_PrivKey(CRYS_RSAUserPrivKey_t *UserPrivKey_ptr, uint8_t *PrivExponent_ptr,
...
*/
CIMPORT_C CRYSError_t CRYS_RSA_Build_PrivKeyCRT(CRYS_RSAUserPrivKey_t *UserPrivKey_ptr, uint8_t *P_ptr, uint16_t PSize,
...
*/
CIMPORT_C CRYSError_t CRYS_RSA_Get_PubKey(CRYS_RSAUserPubKey_t *UserPubKey_ptr, uint8_t *Exponent_ptr,
...
*/
CIMPORT_C CRYSError_t CRYS_RSA_Get_ModSizeFromPubKey(CRYS_RSAUserPubKey_t *UserPubKey_ptr, uint16_t *ModulusSize_ptr);
