...
*/
CIMPORT_C CRYSError_t CRYS_RSA_KG_GenerateKeyPair(uint8_t *pubExp_ptr, uint16_t pubExpSizeInBytes, uint32_t keySize,
...
CIMPORT_C CRYSError_t CRYS_RSA_KG_GenerateKeyPairCRT(uint8_t *pubExp_ptr, uint16_t pubExpSizeInBytes, uint32_t keySize,
                                                     CRYS_RSAUserPrivKey_t *userPrivKey_ptr,
                                                     CRYS_RSAUserPubKey_t *userPubKey_ptr,
                                                     CRYS_RSAKGData_t *keyGenData_ptr);
