 ...
 */
CIMPORT_C CRYSError_t CRYS_RSA_PRIM_Encrypt(CRYS_RSAUserPubKey_t *UserPubKey_ptr, CRYS_RSAPrimeData_t *PrimeData_ptr,
...
CRYS_RSA_PRIM_Decrypt implements the RSADP algorithm as defined in PKCS#1 v2.1 6.1.2
  ...
  @return CRYSError_t - CRYS_OK,
                        ...
                        CRYS_RSA_INVALID_MESSAGE_VAL
 */
CIMPORT_C CRYSError_t CRYS_RSA_PRIM_Decrypt(CRYS_RSAUserPrivKey_t *UserPrivKey_ptr, CRYS_RSAPrimeData_t *PrimeData_ptr,
                                            uint8_t *Data_ptr, uint16_t DataSize, uint8_t *Output_ptr);
