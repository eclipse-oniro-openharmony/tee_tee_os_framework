...
*/
CIMPORT_C CRYSError_t _DX_RSA_SCHEMES_Encrypt(CRYS_RSAUserPubKey_t *UserPubKey_ptr, CRYS_RSAPrimeData_t *PrimeData_ptr,
...
#define CRYS_RSA_OAEP_Encrypt(UserPubKey_ptr, PrimeData_ptr, HashMode, L, Llen, MGF, Data_ptr, DataSize, Output_ptr) \
    _DX_RSA_SCHEMES_Encrypt(UserPubKey_ptr, PrimeData_ptr, HashMode /* CRYS_RSA_HASH_SHA1_mode */, L, Llen, MGF,       \
...
#define CRYS_RSA_PKCS1v15_Encrypt(UserPubKey_ptr, PrimeData_ptr, DataIn_ptr, DataInSize, Output_ptr)                  \
    _DX_RSA_SCHEMES_Encrypt(UserPubKey_ptr, PrimeData_ptr, CRYS_RSA_HASH_NO_HASH_mode, DX_NULL, 0, CRYS_PKCS1_NO_MGF, \
                            DataIn_ptr, DataInSize, Output_ptr, CRYS_PKCS1_VER15)
...
*/
CIMPORT_C CRYSError_t _DX_RSA_SCHEMES_Decrypt(CRYS_RSAUserPrivKey_t *UserPrivKey_ptr,
...
*/
#define CRYS_RSA_OAEP_Decrypt(UserPrivKey_ptr, PrimeData_ptr, HashMode, L, Llen, MGF, Data_ptr, DataSize, Output_ptr, \
                              OutputSize_ptr)                                                                         \
    _DX_RSA_SCHEMES_Decrypt(UserPrivKey_ptr, PrimeData_ptr, HashMode /* CRYS_RSA_HASH_SHA1_mode */, L, Llen, MGF,       \
...
#define CRYS_RSA_PKCS1v15_Decrypt(UserPrivKey_ptr, PrimeData_ptr, DataIn_ptr, DataInSize, Output_ptr, OutputSize_ptr)  \
    _DX_RSA_SCHEMES_Decrypt(UserPrivKey_ptr, PrimeData_ptr, CRYS_RSA_HASH_NO_HASH_mode, DX_NULL, 0, CRYS_PKCS1_NO_MGF, \
                            DataIn_ptr, DataInSize, Output_ptr, OutputSize_ptr, CRYS_PKCS1_VER15)
...
CIMPORT_C CRYSError_t _DX_RSA_SignUpdate(CRYS_RSAPrivUserContext_t *UserContext_ptr, uint8_t *DataIn_ptr,
                                         uint32_t DataInSize);
...
CIMPORT_C CRYSError_t _DX_RSA_SignFinish(CRYS_RSAPrivUserContext_t *UserContext_ptr, uint8_t *Output_ptr,
...
/*
   ...
   @return CRYSError_t - CRYS_OK,
                         ...
                         CRYS_RSA_INVALID_SIGNATURE_BUFFER_SIZE
*/
CIMPORT_C CRYSError_t _DX_RSA_Sign(CRYS_RSAPrivUserContext_t *UserContext_ptr, CRYS_RSAUserPrivKey_t *UserPrivKey_ptr,
...
#define CRYS_RSA_PKCS1v15_Sign(UserContext_ptr, UserPrivKey_ptr, hashFunc, DataIn_ptr, DataInSize, Output_ptr,         \
                               OutputSize_ptr)                                                                         \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (hashFunc), (CRYS_PKCS1_NO_MGF), 0, (DataIn_ptr), (DataInSize), \
...
#define CRYS_RSA_PKCS1v15_SHA1_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (CRYS_RSA_After_SHA1_mode), (CRYS_PKCS1_NO_MGF), 0,    \
                 (DataIn_ptr), CRYS_HASH_SHA1_DIGEST_SIZE_IN_BYTES, (Output_ptr), (OutputSize_ptr), CRYS_PKCS1_VER15)
...
#define CRYS_RSA_PKCS1v15_MD5_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr)        \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), CRYS_RSA_After_MD5_mode, CRYS_PKCS1_NO_MGF, 0, (DataIn_ptr), \
                 CRYS_HASH_MD5_DIGEST_SIZE_IN_BYTES, (Output_ptr), (OutputSize_ptr), CRYS_PKCS1_VER15)
...
#define CRYS_RSA_PKCS1v15_SHA224_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (CRYS_RSA_After_SHA224_mode), (CRYS_PKCS1_NO_MGF), 0,    \
...
#define CRYS_RSA_PKCS1v15_SHA256_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (CRYS_RSA_After_SHA256_mode), (CRYS_PKCS1_NO_MGF), 0,    \
...
#define CRYS_RSA_PKCS1v15_SHA384_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (CRYS_RSA_After_SHA384_mode), (CRYS_PKCS1_NO_MGF), 0,    \
...
#define CRYS_RSA_PKCS1v15_SHA512_Sign(UserContext_ptr, UserPrivKey_ptr, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign((UserContext_ptr), (UserPrivKey_ptr), (CRYS_RSA_After_SHA512_mode), (CRYS_PKCS1_NO_MGF), 0,    \
...
#define CRYS_RSA_PSS_Sign(UserContext_ptr, UserPrivKey_ptr, hashFunc, MGF, SaltLen, DataIn_ptr, DataInSize,    \
                          Output_ptr, OutputSize_ptr)                                                          \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, hashFunc, MGF, SaltLen, DataIn_ptr, DataInSize, Output_ptr, \
...
#define CRYS_RSA_PSS_SHA1_Sign(UserContext_ptr, UserPrivKey_ptr, MGF, SaltLen, DataIn_ptr, Output_ptr, OutputSize_ptr) \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, CRYS_RSA_After_SHA1_mode, MGF, SaltLen, DataIn_ptr,                 \
...
#define CRYS_RSA_PSS_SHA224_Sign(UserContext_ptr, UserPrivKey_ptr, MGF, SaltLen, DataIn_ptr, Output_ptr, \
                                 OutputSize_ptr)                                                         \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, CRYS_RSA_After_SHA224_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA256_Sign(UserContext_ptr, UserPrivKey_ptr, MGF, SaltLen, DataIn_ptr, Output_ptr, \
                                 OutputSize_ptr)                                                         \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, CRYS_RSA_After_SHA256_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA384_Sign(UserContext_ptr, UserPrivKey_ptr, MGF, SaltLen, DataIn_ptr, Output_ptr, \
                                 OutputSize_ptr)                                                         \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, CRYS_RSA_After_SHA384_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA512_Sign(UserContext_ptr, UserPrivKey_ptr, MGF, SaltLen, DataIn_ptr, Output_ptr, \
                                 OutputSize_ptr)                                                         \
    _DX_RSA_Sign(UserContext_ptr, UserPrivKey_ptr, CRYS_RSA_After_SHA512_mode, MGF, SaltLen, DataIn_ptr, \
...
CIMPORT_C CRYSError_t _DX_RSA_VerifyUpdate(CRYS_RSAPubUserContext_t *UserContext_ptr, uint8_t *DataIn_ptr,
                                           uint32_t DataInSize);
...
CIMPORT_C CRYSError_t _DX_RSA_VerifyFinish(CRYS_RSAPubUserContext_t *UserContext_ptr, uint8_t *Sig_ptr);
...
/*
   ...
   and releases the context.
*/
#define CRYS_RSA_PKCS1v15_VerifyFinish(UserContext_ptr, Sig_ptr) _DX_RSA_VerifyFinish(UserContext_ptr, Sig_ptr)
...
/*
   ...
   and releases the context.
*/
#define CRYS_RSA_PSS_VerifyFinish(UserContext_ptr, Sig_ptr) _DX_RSA_VerifyFinish(UserContext_ptr, Sig_ptr)
...
CIMPORT_C CRYSError_t _DX_RSA_Verify(CRYS_RSAPubUserContext_t *UserContext_ptr, CRYS_RSAUserPubKey_t *UserPubKey_ptr,
                                     CRYS_RSA_HASH_OpMode_t hashFunc, CRYS_PKCS1_MGF_t MGF, uint16_t SaltLen,
...
#define CRYS_RSA_PKCS1v15_Verify(UserContext_ptr, UserPubKey_ptr, hashFunc, DataIn_ptr, DataInSize, Sig_ptr)         \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, hashFunc, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, DataInSize, Sig_ptr, \
                   CRYS_PKCS1_VER15)
...
#define CRYS_RSA_PKCS1v15_MD5_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_MD5_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PKCS1v15_SHA1_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA1_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PKCS1v15_SHA224_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA224_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PKCS1v15_SHA256_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA256_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PKCS1v15_SHA384_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA384_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PKCS1v15_SHA512_Verify(UserContext_ptr, UserPubKey_ptr, DataIn_ptr, Sig_ptr)                     \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA512_mode, CRYS_PKCS1_NO_MGF, 0, DataIn_ptr, \
...
#define CRYS_RSA_PSS_Verify(UserContext_ptr, UserPubKey_ptr, hashFunc, MGF, SaltLen, DataIn_ptr, DataInSize, Sig_ptr) \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, hashFunc, MGF, SaltLen, DataIn_ptr, DataInSize, Sig_ptr,          \
                   CRYS_PKCS1_VER21)
...
#define CRYS_RSA_PSS_SHA1_Verify(UserContext_ptr, UserPubKey_ptr, MGF, SaltLen, DataIn_ptr, Sig_ptr)    \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA1_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA224_Verify(UserContext_ptr, UserPubKey_ptr, MGF, SaltLen, DataIn_ptr, Sig_ptr)    \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA224_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA256_Verify(UserContext_ptr, UserPubKey_ptr, MGF, SaltLen, DataIn_ptr, Sig_ptr)    \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA256_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA384_Verify(UserContext_ptr, UserPubKey_ptr, MGF, SaltLen, DataIn_ptr, Sig_ptr)    \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA384_mode, MGF, SaltLen, DataIn_ptr, \
...
#define CRYS_RSA_PSS_SHA512_Verify(UserContext_ptr, UserPubKey_ptr, MGF, SaltLen, DataIn_ptr, Sig_ptr)    \
    _DX_RSA_Verify(UserContext_ptr, UserPubKey_ptr, CRYS_RSA_After_SHA512_mode, MGF, SaltLen, DataIn_ptr, \
