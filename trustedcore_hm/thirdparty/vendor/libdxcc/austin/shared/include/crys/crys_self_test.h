...
#define CRYS_SELF_TEST_ALL_BIT                                                                            \
    (CRYS_SELF_TEST_AES_BIT | CRYS_SELF_TEST_DES_BIT | CRYS_SELF_TEST_HASH_BIT | CRYS_SELF_TEST_ECC_BIT | \
     CRYS_SELF_TEST_HMAC_BIT | CRYS_SELF_TEST_RSA_ENCDEC_BIT)

#define CRYS_SELF_TEST_NO_RND                                                                              \
    (CRYS_SELF_TEST_AES_BIT | CRYS_SELF_TEST_DES_BIT | CRYS_SELF_TEST_HASH_BIT | CRYS_SELF_TEST_HMAC_BIT | \
...
CRYSError_t CRYS_SelfTest(uint16_t EnginesSelect, uint16_t *EnginesTestResult_ptr);
