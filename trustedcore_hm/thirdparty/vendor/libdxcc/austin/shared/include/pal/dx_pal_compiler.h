...
#define DX_PAL_COMPILER_SIZEOF_STRUCT_MEMBER(type_name, member_name) sizeof(((type_name *)0)->member_name)
...
#define DX_PAL_COMPILER_ASSERT(cond, message) enum { DX_ASSERT_CONCAT(assert_line_, __LINE__) = 1 / (!!(cond)) }
