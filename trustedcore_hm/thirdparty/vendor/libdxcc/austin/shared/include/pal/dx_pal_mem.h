 ...
 */
int32_t DX_PAL_MemCmp(const void *aTarget, const void *aSource, uint32_t aSize);
 ...
 */
DxError_t DX_PAL_SecMemCmp(const uint8_t *aTarget, const uint8_t *aSource, uint32_t aSize);
 ...
 * @return void
 */
void DX_PAL_MemCopy(const void *aDestination, const void *aSource, uint32_t aSize);
 ...
 * @return void
 */
void DX_PAL_MemMove(const void *aDestination, const void *aSource, uint32_t aSize);
 ...
 * @return void
 */
void DX_PAL_MemSet(const void *aTarget, const uint8_t aChar, uint32_t aSize);
 ...
 * @return void
 */
void DX_PAL_MemSetZero(const void *aTarget, uint32_t aSize);
 ...
 */
void *DX_PAL_MemRealloc(void *aBuffer, uint32_t aNewSize);
