...
#ifndef _DX_GENERAL_DEFS_H
#define _DX_GENERAL_DEFS_H
...
/* general defintions */
/* ------------------------- */
#define DX_CC_AES_KDR_MAX_SIZE_BYTES 32
#define DX_CC_AES_KDR_MAX_SIZE_WORDS (DX_CC_AES_KDR_MAX_SIZE_BYTES / sizeof(uint32_t))
